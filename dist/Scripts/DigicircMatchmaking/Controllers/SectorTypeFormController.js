...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var _this = this;
        var SectorTypeFormConditionalFormattings = [
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
                                return Joove.Common.nullSafe(function () { return window["scope_SectorTypeForm"].model.Title; }, "").trim();
                            }, "")); }, false)];
                    });
                }); },
        ...
        var SectorTypeFormDataValidations = [];
        var SectorTypeFormCalculatedExpressions = [];
        var SectorTypeFormController = /** @class */ (function () {
            function SectorTypeFormController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.SectorTypeForm.SectorTypeFormViewModel._initializeFrom($scope.model, context);
                };
            ...
            SectorTypeFormController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return SectorTypeFormController;
        }());
        angular.module("Application").controller("SectorTypeFormController", ["$scope", "$timeout", SectorTypeFormController]);
