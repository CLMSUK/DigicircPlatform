                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
                                return Joove.Common.nullSafe(function () { return window["scope_ApplicationSettingsList"].model.Title; }, "").trim();
                            }, "")); }, false)];
                    });
                }); },
        ...
        var ApplicationSettingsListController = /** @class */ (function () {
            function ApplicationSettingsListController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel._initializeFrom($scope.model, context);
                };
