...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var _this = this;
        var ClusterInitializationConditionalFormattings = [
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
                                return Joove.Common.nullSafe(function () { return window["scope_ClusterInitialization"].model.Title; }, "").trim();
                            }, "")); }, false)];
                    });
                }); },
        ...
        var ClusterInitializationDataValidations = [];
        var ClusterInitializationCalculatedExpressions = [];
        var ClusterInitializationController = /** @class */ (function () {
            function ClusterInitializationController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.ClusterInitialization.ClusterInitializationViewModel._initializeFrom($scope.model, context);
                };
            ...
            ClusterInitializationController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return ClusterInitializationController;
        }());
        angular.module("Application").controller("ClusterInitializationController", ["$scope", "$timeout", ClusterInitializationController]);
