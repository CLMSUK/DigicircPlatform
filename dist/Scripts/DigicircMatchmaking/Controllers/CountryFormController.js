...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var _this = this;
        var CountryFormConditionalFormattings = [
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
                                return Joove.Common.nullSafe(function () { return window["scope_CountryForm"].model.Title; }, "").trim();
                            }, "")); }, false)];
                    });
                }); },
        ...
        var CountryFormDataValidations = [];
        var CountryFormCalculatedExpressions = [];
        var CountryFormController = /** @class */ (function () {
            function CountryFormController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.CountryForm.CountryFormViewModel._initializeFrom($scope.model, context);
                };
            ...
            CountryFormController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return CountryFormController;
        }());
        angular.module("Application").controller("CountryFormController", ["$scope", "$timeout", CountryFormController]);
