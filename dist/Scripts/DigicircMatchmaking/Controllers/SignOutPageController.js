        ...
        var SignOutPageController = /** @class */ (function () {
            function SignOutPageController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.SignOutPage.SignOutPageViewModel._initializeFrom($scope.model, context);
                };
            ...
            SignOutPageController.prototype.init = function ($scope, $timeout) {
                ...
                // Controller actions
                $scope.actions = {
                    SignOut: function (fromMatching, _cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
