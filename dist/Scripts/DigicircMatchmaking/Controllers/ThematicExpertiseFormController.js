...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var _this = this;
        var ThematicExpertiseFormConditionalFormattings = [
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
                                return Joove.Common.nullSafe(function () { return window["scope_ThematicExpertiseForm"].model.Title; }, "").trim();
                            }, "")); }, false)];
                    });
                }); },
        ...
        var ThematicExpertiseFormDataValidations = [];
        var ThematicExpertiseFormCalculatedExpressions = [];
        var ThematicExpertiseFormController = /** @class */ (function () {
            function ThematicExpertiseFormController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.ThematicExpertiseForm.ThematicExpertiseFormViewModel._initializeFrom($scope.model, context);
                };
            ...
            ThematicExpertiseFormController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return ThematicExpertiseFormController;
        }());
        angular.module("Application").controller("ThematicExpertiseFormController", ["$scope", "$timeout", ThematicExpertiseFormController]);
