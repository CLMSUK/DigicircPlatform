...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var _this = this;
        var ManageActorsConditionalFormattings = [
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
                                return Joove.Common.nullSafe(function () { return window["scope_ManageActors"].model.Title; }, "").trim();
                            }, "")); }, false)];
                    });
                }); },
        ...
        var ManageActorsDataValidations = [];
        var ManageActorsCalculatedExpressions = [];
        ...
        var PartialViewPartialModelStructure = /** @class */ (function () {
            ...
            Object.defineProperty(PartialViewPartialModelStructure.prototype, "Actor", {
                get: function () { return window["scope_ActorsToAdministrators"].model.SelectedActor; },
                set: function (__val) {
        ...
        var ManageActorsController = /** @class */ (function () {
            function ManageActorsController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.ManageActors.ManageActorsViewModel._initializeFrom($scope.model, context);
                };
            ...
            ManageActorsController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                ...
                $scope.actions = {
                    ...
                    EsSync: function (_cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            Joove.Common.autocompleteFix();
                    ...
                    KnowledgeSync: function (_cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            Joove.Common.autocompleteFix();
                            Joove.Core.executeControllerActionNew({
                    ...
                    SaveActor: function (_cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            Joove.Common.autocompleteFix();
                            Joove.Core.executeControllerActionNew({
                    ...
                    SelectUsers: function (actor, _cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            Joove.Common.autocompleteFix();
                            Joove.Core.executeControllerActionNew({
                ...
                $scope.actions.ActorsToAdministrators = {
                    Add: function (_partialControlName, user, _cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                ...
                $scope.eventCallbacks = {
                    ...
                    EsSyncButtonClicked: function (e, DataItem, _parents) {
                        if (e != null) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                        if (_this.timeoutDelayLockEsSyncButtonClicked != null) {
                            $timeout.cancel(_this.timeoutDelayLockEsSyncButtonClicked);
                        }
                        _this.timeoutDelayLockEsSyncButtonClicked = $timeout(function () {
                            Joove.Common.setControlKeyPressed(e, 0);
                    ...
                    KnowledgeSyncButtonClicked: function (e, DataItem, _parents) {
                        if (e != null) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                        if (_this.timeoutDelayLockKnowledgeSyncButtonClicked != null) {
                            $timeout.cancel(_this.timeoutDelayLockKnowledgeSyncButtonClicked);
                        }
                        _this.timeoutDelayLockKnowledgeSyncButtonClicked = $timeout(function () {
                            Joove.Common.setControlKeyPressed(e, 0);
                            Joove.Common.setLastClickedElement(e);
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                    ...
                    AddButtonClicked: function (e, DataItem, _parents) {
                        if (e != null) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                        if (_this.timeoutDelayLockAddButtonClicked != null) {
                            $timeout.cancel(_this.timeoutDelayLockAddButtonClicked);
                        }
                        _this.timeoutDelayLockAddButtonClicked = $timeout(function () {
                            Joove.Common.setControlKeyPressed(e, 0);
                            Joove.Common.setLastClickedElement(e);
                            Joove.Validation.Manager.validateFormAndExecute(function () {
            ...
            return ManageActorsController;
        }());
        angular.module("Application").controller("ManageActorsController", ["$scope", "$timeout", ManageActorsController]);
