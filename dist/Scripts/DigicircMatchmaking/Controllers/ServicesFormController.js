...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var _this = this;
        var ServicesFormConditionalFormattings = [
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
                                return Joove.Common.nullSafe(function () { return window["scope_ServicesForm"].model.Title; }, "").trim();
                            }, "")); }, false)];
                    });
                }); },
        ...
        var ServicesFormDataValidations = [];
        var ServicesFormCalculatedExpressions = [];
        var ServicesFormController = /** @class */ (function () {
            function ServicesFormController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.ServicesForm.ServicesFormViewModel._initializeFrom($scope.model, context);
                };
            ...
            ServicesFormController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return ServicesFormController;
        }());
        angular.module("Application").controller("ServicesFormController", ["$scope", "$timeout", ServicesFormController]);
