...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var _this = this;
        var UnitOfMeasurementFormConditionalFormattings = [
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
                                return Joove.Common.nullSafe(function () { return window["scope_UnitOfMeasurementForm"].model.Title; }, "").trim();
                            }, "")); }, false)];
                    });
                }); },
        ...
        var UnitOfMeasurementFormDataValidations = [];
        var UnitOfMeasurementFormCalculatedExpressions = [];
        var UnitOfMeasurementFormController = /** @class */ (function () {
            function UnitOfMeasurementFormController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.UnitOfMeasurementForm.UnitOfMeasurementFormViewModel._initializeFrom($scope.model, context);
                };
            ...
            UnitOfMeasurementFormController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return UnitOfMeasurementFormController;
        }());
        angular.module("Application").controller("UnitOfMeasurementFormController", ["$scope", "$timeout", UnitOfMeasurementFormController]);
