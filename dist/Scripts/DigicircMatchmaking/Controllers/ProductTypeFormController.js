...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var _this = this;
        var ProductTypeFormConditionalFormattings = [
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
                                return Joove.Common.nullSafe(function () { return window["scope_ProductTypeForm"].model.Title; }, "").trim();
                            }, "")); }, false)];
                    });
                }); },
        ...
        var ProductTypeFormDataValidations = [];
        var ProductTypeFormCalculatedExpressions = [];
        ...
        var ProductTypeFormController = /** @class */ (function () {
            function ProductTypeFormController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.ProductTypeForm.ProductTypeFormViewModel._initializeFrom($scope.model, context);
                };
            ...
            ProductTypeFormController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                ...
                $scope.actions = {
                    ...
                    DeleteSubType: function (subType, _cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            switch (_a.label) {
                                case 0:
                                    ...
                                    implementation = function () { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            Joove.Common.nullSafe(function () { return window["scope_ProductTypeForm"].model.ProductType.SybTypes.remove(subType); }, null);
            ...
            return ProductTypeFormController;
        }());
        angular.module("Application").controller("ProductTypeFormController", ["$scope", "$timeout", ProductTypeFormController]);
