        ...
        var SignInPageController = /** @class */ (function () {
            function SignInPageController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.SignInPage.SignInPageViewModel._initializeFrom($scope.model, context);
                };
            ...
            SignInPageController.prototype.init = function ($scope, $timeout) {
                ...
                // Controller actions
                $scope.actions = {
                    Load: function (fromMatching, _cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                    ...
                    LoadDefault: function (_cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            Joove.Common.autocompleteFix();
                    ...
                    SignIn: function (fromMatching, _cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            Joove.Common.autocompleteFix();
                            window._context.isDirty = false;
                ...
                $scope.eventCallbacks = {
                    ButtonClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockButtonClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("RegisterForm", "Index", "GET", [Joove.Common.nullSafe(function () { return window["scope_SignInPage"].model.FromMatching; }, false)], null, null, openInNewWindow);
                    ...
                    Button3Clicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockButton3Clicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("ForgotUsername", "Render", "GET", [Joove.Common.nullSafe(function () { return window["scope_SignInPage"].model.FromMatching; }, false)], null, null, openInNewWindow);
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
                    Button2Clicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockButton2Clicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("ForgotPassword", "Render", "GET", [Joove.Common.nullSafe(function () { return window["scope_SignInPage"].model.FromMatching; }, false)], null, null, openInNewWindow);
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
                    Button1Clicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockButton1Clicked = $timeout(function () {
                            ...
                            Joove.Common.setLastClickedElement(e);
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                $scope.actions.SignIn(Joove.Common.nullSafe(function () { return window["scope_SignInPage"].model.FromMatching; }, false), null, null, e);
