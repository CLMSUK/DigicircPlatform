...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var _this = this;
        var BusinessTypeFormConditionalFormattings = [
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
                                return Joove.Common.nullSafe(function () { return window["scope_BusinessTypeForm"].model.Title; }, "").trim();
                            }, "")); }, false)];
                    });
                }); },
        ...
        var BusinessTypeFormDataValidations = [];
        var BusinessTypeFormCalculatedExpressions = [];
        var BusinessTypeFormController = /** @class */ (function () {
            function BusinessTypeFormController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.BusinessTypeForm.BusinessTypeFormViewModel._initializeFrom($scope.model, context);
                };
            ...
            BusinessTypeFormController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return BusinessTypeFormController;
        }());
        angular.module("Application").controller("BusinessTypeFormController", ["$scope", "$timeout", BusinessTypeFormController]);
