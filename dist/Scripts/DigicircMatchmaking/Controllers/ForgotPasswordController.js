        ...
        var ForgotPasswordController = /** @class */ (function () {
            function ForgotPasswordController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.ForgotPassword.ForgotPasswordViewModel._initializeFrom($scope.model, context);
                };
            ...
            ForgotPasswordController.prototype.init = function ($scope, $timeout) {
                ...
                $scope.actions = {
                    ...
                    ResetPassword: function (fromMatching, username, key, _cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            Joove.Common.autocompleteFix();
                    ...
                    Button1Clicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockButton1Clicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("SignInPage", "Load", "GET", [Joove.Common.nullSafe(function () { return window["scope_ForgotPassword"].model.FromMatching; }, false)], null, null, openInNewWindow);
                    ...
                    Button3Clicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockButton3Clicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("ForgotUsername", "Render", "GET", [Joove.Common.nullSafe(function () { return window["scope_ForgotPassword"].model.FromMatching; }, false)], null, null, openInNewWindow);
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
