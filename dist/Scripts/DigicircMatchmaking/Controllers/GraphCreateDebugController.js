...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var GraphCreateDebugConditionalFormattings = [];
        var GraphCreateDebugDataValidations = [];
        var GraphCreateDebugCalculatedExpressions = [];
        var GraphCreateDebugController = /** @class */ (function () {
            function GraphCreateDebugController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.GraphCreateDebug.GraphCreateDebugViewModel._initializeFrom($scope.model, context);
                };
            ...
            GraphCreateDebugController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return GraphCreateDebugController;
        }());
        angular.module("Application").controller("GraphCreateDebugController", ["$scope", "$timeout", GraphCreateDebugController]);
