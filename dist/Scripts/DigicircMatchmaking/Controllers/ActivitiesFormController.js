...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var _this = this;
        var ActivitiesFormConditionalFormattings = [
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
                                return Joove.Common.nullSafe(function () { return window["scope_ActivitiesForm"].model.Title; }, "").trim();
                            }, "")); }, false)];
                    });
                }); },
        ...
        var ActivitiesFormDataValidations = [];
        var ActivitiesFormCalculatedExpressions = [];
        var ActivitiesFormController = /** @class */ (function () {
            function ActivitiesFormController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.ActivitiesForm.ActivitiesFormViewModel._initializeFrom($scope.model, context);
                };
            ...
            ActivitiesFormController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return ActivitiesFormController;
        }());
        angular.module("Application").controller("ActivitiesFormController", ["$scope", "$timeout", ActivitiesFormController]);
