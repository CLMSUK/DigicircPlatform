...
using DigicircMatchmaking.UI.Controllers.ManageUser;
using AppCode;
...
namespace DigicircMatchmaking.UI.ViewModels.ManageUser
{
    ...
    [OriginalType(typeof(DigicircMatchmaking.UI.ViewModels.ManageUser.ManageUserViewModel))]
    public class ManageUserViewModelDTO : MasterPageForSlideViewModelDTO, IViewModelDTO<DigicircMatchmaking.UI.ViewModels.ManageUser.ManageUserViewModel>
    {

        [JsonConstructor]
        public ManageUserViewModelDTO() { }
        public ManageUserViewModelDTO(DigicircMatchmaking.UI.ViewModels.ManageUser.ManageUserViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public string PasswordRetype;
        public string NewPassword;
        public override string _originalTypeClassName => typeof(DigicircMatchmaking.UI.ViewModels.ManageUser.ManageUserViewModel).FullName;
        public List<SelectedItemInfo<int?>> Button1SelectedItemKeys;
        public List<SelectedItemInfo<int?>> Button2SelectedItemKeys;

        public new DigicircMatchmaking.UI.ViewModels.ManageUser.ManageUserViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DigicircMatchmaking.UI.ViewModels.ManageUser.ManageUserViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DigicircMatchmaking.UI.ViewModels.ManageUser.ManageUserViewModel();
        }
        new  public DigicircMatchmaking.UI.ViewModels.ManageUser.ManageUserViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DigicircMatchmaking.UI.ViewModels.ManageUser.ManageUserViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DigicircMatchmaking.UI.ViewModels.ManageUser.ManageUserViewModel original)
        {
            if (original == null) return;
