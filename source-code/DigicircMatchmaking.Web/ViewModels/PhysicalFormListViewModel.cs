...
using DigicircMatchmaking.UI.Controllers.PhysicalFormList;
using AppCode;
...
namespace DigicircMatchmaking.UI.ViewModels.PhysicalFormList
{
    public class PhysicalFormListViewModel : SymbiosisMasterPageViewModel
    {
        public List<SelectedItemInfo<DigicircMatchmaking.BO.PhysicalForm>> PhysicalFormListSelectedItems;


        public PhysicalFormListViewModel()
        {
        }
    ...
    [OriginalType(typeof(DigicircMatchmaking.UI.ViewModels.PhysicalFormList.PhysicalFormListViewModel))]
    public class PhysicalFormListViewModelDTO : SymbiosisMasterPageViewModelDTO, IViewModelDTO<DigicircMatchmaking.UI.ViewModels.PhysicalFormList.PhysicalFormListViewModel>
    {

        [JsonConstructor]
        public PhysicalFormListViewModelDTO() { }
        public PhysicalFormListViewModelDTO(DigicircMatchmaking.UI.ViewModels.PhysicalFormList.PhysicalFormListViewModel original, bool parentIsDirty = false)  : base(original)
        {
            if (original == null) return;
            PhysicalFormListSelectedItemKeys = original.PhysicalFormListSelectedItems == null
                                               ? null
                                               : original.PhysicalFormListSelectedItems.Select(x => new SelectedItemInfo<int?>(x.SelectedItems.Select(y => y.Id).ToList(), x.Indexes, x.FullRecordsetSelected)).ToList();
        }
        public override string _originalTypeClassName => typeof(DigicircMatchmaking.UI.ViewModels.PhysicalFormList.PhysicalFormListViewModel).FullName;
        public List<SelectedItemInfo<int?>> PhysicalFormListSelectedItemKeys;

        public new DigicircMatchmaking.UI.ViewModels.PhysicalFormList.PhysicalFormListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DigicircMatchmaking.UI.ViewModels.PhysicalFormList.PhysicalFormListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DigicircMatchmaking.UI.ViewModels.PhysicalFormList.PhysicalFormListViewModel();
        }
        new  public DigicircMatchmaking.UI.ViewModels.PhysicalFormList.PhysicalFormListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DigicircMatchmaking.UI.ViewModels.PhysicalFormList.PhysicalFormListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DigicircMatchmaking.UI.ViewModels.PhysicalFormList.PhysicalFormListViewModel original)
        {
            if (original == null) return;
            base.Hydrate(original);
            original.PhysicalFormListSelectedItems = PhysicalFormListSelectedItemKeys == null
                    ? new List<SelectedItemInfo<DigicircMatchmaking.BO.PhysicalForm>>()
                    : PhysicalFormListSelectedItemKeys.Select(x => new SelectedItemInfo<DigicircMatchmaking.BO.PhysicalForm>(x.SelectedItems.Select(y => ViewModels.PhysicalFormList.PhysicalFormDataSet_PhysicalFormDTO.GetModelByKey(y)).ToList(), x.Indexes, x.FullRecordsetSelected)).ToList();
        }
    }
    ...
    public class PhysicalFormDataSet_PhysicalFormDTO : PhysicalFormDataSet_ValueTypeDTO, IViewModelDTO<DigicircMatchmaking.BO.PhysicalForm>
    {
        ...
        public new static PhysicalFormDataSet_PhysicalFormDTO GetInstance(object key, string jbID)
        {
            ...
            if(foundEntry == null && !string.IsNullOrWhiteSpace(jbID))
            {
                ...
                {
                    var controller = new PhysicalFormListController();
