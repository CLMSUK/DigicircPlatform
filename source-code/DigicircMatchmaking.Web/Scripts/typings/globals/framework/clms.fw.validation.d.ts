declare namespace Joove.Validation {
    ...
    class Bindings {
        ...
        private static updateMasterValidationsSummary(entry);
        static resetAllRequiredFieldOccurencesInSummary(): void;
        static removeFromMasterSummaryNotTriggeredRequiredFields(controlNames: Array<string>): void;
        ...
        static removeFromMasterSummaryWhenNotTriggered(dv: JbRule): void;
        static removeFromSummaryWhenNotTriggered(dv: JbRule): void;
        private static updatedMasterValidationSummaryForEntryInContext(entry, existing, alreadyInSummary);
        private static updatedMasterValidationSummaryForEntryWithoutContext(entry, existing, alreadyInSummary);
