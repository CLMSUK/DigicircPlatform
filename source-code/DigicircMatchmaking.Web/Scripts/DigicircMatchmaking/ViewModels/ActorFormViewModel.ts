...
namespace DigicircMatchmaking.ViewModels.ActorForm {
export class ActorFormViewModel extends DigicircMatchmaking.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
    ...
    public static _initializeFrom(original: ActorFormViewModel, ignoreReadOnlyProperties: boolean = false, context = new Joove.DTOHelper()): ActorFormViewModel {
        if(original == null) return null;
        // if (context.Has(original)) {
        //    return context.Get(original);
        // }
var result:
        ActorFormViewModel = new ActorFormViewModel();
    ...
    public _hydrateActorFormViewModel(original: ActorFormViewModel, ignoreReadOnlyProperties: boolean, context = new Joove.DTOHelper()): void {
        ...
        if(original.NewClusterName !== undefined) this.NewClusterName = original.NewClusterName;
        if(original.ManuallySetGeolocation !== undefined) this.ManuallySetGeolocation = original.ManuallySetGeolocation;
        ...
        if (original.DropdownBox3__InitialSelection !== undefined) this.DropdownBox3__InitialSelection = original.DropdownBox3__InitialSelection;
    ...
    public _reduceData(ignoreReadOnlyProperties: boolean): ActorFormViewModel {
        var reduced = ActorFormViewModel._initializeFrom(this, ignoreReadOnlyProperties);
        ActorFormViewModel._deleteDropDownInitialValues(reduced);
        return reduced;
    }

    public static _deleteDropDownInitialValues(reduced: ActorFormViewModel) {
...
public NewClusterName:
    any;
public ManuallySetGeolocation:
    any;
public DropdownBox1__InitialSelection:
    any;
public DropdownBox3__InitialSelection:
    any;
...
public DropdownBox1SelectedItemKeys:
    any[];
public DropdownBox3SelectedItemKeys:
    any[];
public TextBoxSelectedItemKeys:
    any[];
public DropdownDigitalExpertiseDatasetSelectedItemKeys:
    any[];
...
public DropdownBox4SelectedItemKeys:
    any[];
public NewMap1SelectedItemKeys:
    any[];
}
...
export class Actor_ActorViewModel extends BaseClass.ViewModel  {
    ...
    public static _lightCast(instance: any): any {
        ...
        if(instance.Sites != null) {
            for(let i = 0; i < instance.Sites.length; i++) {
...
var result:
    ...
    public _hydrateActor_ActorViewModel(original: Actor_ActorViewModel, ignoreReadOnlyProperties: boolean, context = new Joove.DTOHelper()): void {
        ...
        if(original.Sites != null) {
            for(let i = 0; i < original.Sites.length; i++) {
...
export class Actor_Actor_Sites_AddressViewModel extends BaseClass.ViewModel  {
    public constructor() {
        super();
    }
    ...
    public static _initializeFrom(original: Actor_Actor_Sites_AddressViewModel, ignoreReadOnlyProperties: boolean = false, context = new Joove.DTOHelper()): Actor_Actor_Sites_AddressViewModel {
        if(original == null) return null;
        // if (context.Has(original)) {
        //    return context.Get(original);
        // }
var result:
        Actor_Actor_Sites_AddressViewModel = new Actor_Actor_Sites_AddressViewModel();
        if (context != null && context.fillDb == true) {
            context.addToDb(original);
        }
    ...
    public _hydrateActor_Actor_Sites_AddressViewModel(original: Actor_Actor_Sites_AddressViewModel, ignoreReadOnlyProperties: boolean, context = new Joove.DTOHelper()): void {
        if(original == null) return;
        ...
        if(original.Country !== undefined) this.Country = Actor_Actor_Sites_Address_Country_CountryViewModel._initializeFrom(original.Country, ignoreReadOnlyProperties, context);
    ...
    public _reduceData(ignoreReadOnlyProperties: boolean): Actor_Actor_Sites_AddressViewModel {
        var reduced = Actor_Actor_Sites_AddressViewModel._initializeFrom(this, ignoreReadOnlyProperties);
...
export class Actor_Actor_Sites_Address_Country_CountryViewModel extends BaseClass.ViewModel  {
    public constructor() {
        super();
    }
    ...
    public static _initializeFrom(original: Actor_Actor_Sites_Address_Country_CountryViewModel, ignoreReadOnlyProperties: boolean = false, context = new Joove.DTOHelper()): Actor_Actor_Sites_Address_Country_CountryViewModel {
        if(original == null) return null;
        // if (context.Has(original)) {
        //    return context.Get(original);
        // }
var result:
        Actor_Actor_Sites_Address_Country_CountryViewModel = new Actor_Actor_Sites_Address_Country_CountryViewModel();
        if (context != null && context.fillDb == true) {
            context.addToDb(original);
        }
    ...
    public _hydrateActor_Actor_Sites_Address_Country_CountryViewModel(original: Actor_Actor_Sites_Address_Country_CountryViewModel, ignoreReadOnlyProperties: boolean, context = new Joove.DTOHelper()): void {
        if(original == null) return;
    ...
    public _reduceData(ignoreReadOnlyProperties: boolean): Actor_Actor_Sites_Address_Country_CountryViewModel {
        var reduced = Actor_Actor_Sites_Address_Country_CountryViewModel._initializeFrom(this, ignoreReadOnlyProperties);
