...
namespace DigicircMatchmaking.ViewModels.FirstAdminSetup {
export class FirstAdminSetupViewModel extends DigicircMatchmaking.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
    }
