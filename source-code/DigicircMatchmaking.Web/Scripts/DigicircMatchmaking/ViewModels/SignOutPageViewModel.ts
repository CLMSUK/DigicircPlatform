...
namespace DigicircMatchmaking.ViewModels.SignOutPage {
export class SignOutPageViewModel extends DigicircMatchmaking.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
    }
