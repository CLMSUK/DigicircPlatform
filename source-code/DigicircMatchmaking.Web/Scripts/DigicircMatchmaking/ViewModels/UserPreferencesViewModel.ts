...
namespace DigicircMatchmaking.ViewModels.UserPreferences {
export class UserPreferencesViewModel extends DigicircMatchmaking.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
    }
