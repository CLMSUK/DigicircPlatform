...
namespace DigicircMatchmaking.ViewModels.PermissionsList {
export class PermissionsListViewModel extends DigicircMatchmaking.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
    }
