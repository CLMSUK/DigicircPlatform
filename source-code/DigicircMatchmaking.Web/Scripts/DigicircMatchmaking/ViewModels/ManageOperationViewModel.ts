...
namespace DigicircMatchmaking.ViewModels.ManageOperation {
export class ManageOperationViewModel extends DigicircMatchmaking.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();
    }
