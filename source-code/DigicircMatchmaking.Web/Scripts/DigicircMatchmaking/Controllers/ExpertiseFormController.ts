...
interface Window { scope_ExpertiseForm: DigicircMatchmaking.Controllers.IExpertiseFormScope; }
namespace DigicircMatchmaking.Controllers {
const ExpertiseFormConditionalFormattings = [
new Joove.JbRule({
...
condition: async (_parents) => {
        return Joove.Common.nullSafe<any>(() => CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
            return Joove.Common.nullSafe<any>(() => window["scope_ExpertiseForm"].model.Title, "").trim();
        }, "")), false);
...
const ExpertiseFormDataValidations = [
                                     ];
const ExpertiseFormCalculatedExpressions = [
        ];
...
export interface IExpertiseFormScope extends Joove.IWebPageScope {
model:
    DigicircMatchmaking.ViewModels.ExpertiseForm.ExpertiseFormViewModel;
...
private timeoutDelayLockcmdCompanySaveClicked:
    ...
    constructor(private $scope: IExpertiseFormScope, $timeout: ng.ITimeoutService) {
        window.scope_ExpertiseForm = $scope;
        $scope.$onControlChanged = function (event, newValue, dontMakeDirty) {
            Joove.Core.onChange(event.target, newValue, dontMakeDirty)
        }

        $scope.dehydrate = (context = null) => DigicircMatchmaking.ViewModels.ExpertiseForm.ExpertiseFormViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IExpertiseFormScope, $timeout: ng.ITimeoutService) {
...
angular.module("Application").controller("ExpertiseFormController", ["$scope", "$timeout", ExpertiseFormController] as Array<string>);
}
