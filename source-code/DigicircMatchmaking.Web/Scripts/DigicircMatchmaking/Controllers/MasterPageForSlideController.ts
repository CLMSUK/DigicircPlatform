...
interface Window { scope_MasterPageForSlide: DigicircMatchmaking.Controllers.IMasterPageForSlideScope; }
...
class MasterPageForSlideController {
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        //
        DigicircMatchmaking.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel._lightCast(window.scope_MasterPageForSlide.model);
    ...
    constructor(private $scope: IMasterPageForSlideScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DigicircMatchmaking.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel._initializeFrom($scope.model, context);
