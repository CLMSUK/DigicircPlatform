...
interface Window { scope_HomePage: DigicircMatchmaking.Controllers.IHomePageScope; }
...
model:
    DigicircMatchmaking.ViewModels.HomePage.HomePageViewModel;
...
class HomePageController {
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DigicircMatchmaking.ViewModels.HomePage.HomePageViewModel._lightCast(window.scope_HomePage.model);
    ...
    constructor(private $scope: IHomePageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DigicircMatchmaking.ViewModels.HomePage.HomePageViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IHomePageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DigicircMatchmaking.ViewModels.HomePage.HomePageViewModel._initializeFrom(window.viewDTO.Model);
