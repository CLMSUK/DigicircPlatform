...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var UnitOfMeasurementListConditionalFormattings = [];
        var UnitOfMeasurementListDataValidations = [];
        var UnitOfMeasurementListCalculatedExpressions = [];
        ...
        var UnitOfMeasurementListController = /** @class */ (function () {
            function UnitOfMeasurementListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.UnitOfMeasurementList.UnitOfMeasurementListViewModel._initializeFrom($scope.model, context);
                };
            ...
            UnitOfMeasurementListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                    ...
                    AddNewClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockAddNewClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("UnitOfMeasurementForm", "Add", "GET", [], null, null, openInNewWindow);
                    ...
                    ModifyClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockModifyClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("UnitOfMeasurementForm", "Edit", "GET", [Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItem($("[jb-id='UnitOfMeasurementList']"), e).Id; }, 0)], null, null, openInNewWindow);
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
                };
            ...
            return UnitOfMeasurementListController;
        }());
        angular.module("Application").controller("UnitOfMeasurementListController", ["$scope", "$timeout", UnitOfMeasurementListController]);
