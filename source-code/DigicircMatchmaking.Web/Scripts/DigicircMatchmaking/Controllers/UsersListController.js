                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
                                return Joove.Common.nullSafe(function () { return window["scope_UsersList"].model.Title; }, "").trim();
                            }, "")); }, false)];
                    });
                }); },
        ...
        var UsersListController = /** @class */ (function () {
            function UsersListController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.UsersList.UsersListViewModel._initializeFrom($scope.model, context);
                };
