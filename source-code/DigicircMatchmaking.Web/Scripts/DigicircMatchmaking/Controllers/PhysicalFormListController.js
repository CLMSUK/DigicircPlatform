...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var PhysicalFormListConditionalFormattings = [];
        var PhysicalFormListDataValidations = [];
        var PhysicalFormListCalculatedExpressions = [];
        ...
        var PhysicalFormListController = /** @class */ (function () {
            function PhysicalFormListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.PhysicalFormList.PhysicalFormListViewModel._initializeFrom($scope.model, context);
                };
            ...
            PhysicalFormListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                    ...
                    AddNewClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockAddNewClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("PhysicalFormForm", "Add", "GET", [], null, null, openInNewWindow);
                    ...
                    ModifyClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockModifyClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("PhysicalFormForm", "Edit", "GET", [Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItem($("[jb-id='PhysicalFormList']"), e).Id; }, 0)], null, null, openInNewWindow);
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
                };
            ...
            return PhysicalFormListController;
        }());
        angular.module("Application").controller("PhysicalFormListController", ["$scope", "$timeout", PhysicalFormListController]);
