...
interface Window { scope_SignInPage: DigicircMatchmaking.Controllers.ISignInPageScope; }
...
model:
    DigicircMatchmaking.ViewModels.SignInPage.SignInPageViewModel;
...
private timeoutDelayLockButton1Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DigicircMatchmaking.ViewModels.SignInPage.SignInPageViewModel._lightCast(window.scope_SignInPage.model);
    ...
    constructor(private $scope: ISignInPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DigicircMatchmaking.ViewModels.SignInPage.SignInPageViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: ISignInPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DigicircMatchmaking.ViewModels.SignInPage.SignInPageViewModel._initializeFrom(window.viewDTO.Model);
...
Load:
            async (fromMatching, _cb, _modalOptions, _e) => {
                ...
                Joove.Core.executeRedirectControllerAction("SignInPage", "Load", "GET", [fromMatching], {}, _modalOptions);
            },
LoadDefault:
            async (_cb, _modalOptions, _e) => {
                ...
                Joove.Core.executeRedirectControllerAction("SignInPage", "LoadDefault", "GET", [], {}, _modalOptions);
            },
SignIn:
            async (fromMatching, _cb, _modalOptions, _e) => {
                Joove.Common.autocompleteFix();
...
queryData: [], postData: {'model': $scope.model, 'fromMatching': fromMatching},
            ...
            (e, DataItem, _parents) => {
                ...
                this.timeoutDelayLockButtonClicked = $timeout(() => {
                    ...
                    Joove.Validation.Manager.validateFormAndExecute(() => {
                        ...
                        if (openInNewWindow) $(e.target).data("openInNewWindow", undefined); Joove.Core.executeRedirectControllerAction("RegisterForm", "Index", "GET", [Joove.Common.nullSafe<any>(() => window["scope_SignInPage"].model.FromMatching, false)], null, null, openInNewWindow);
            ...
            (e, DataItem, _parents) => {
                ...
                this.timeoutDelayLockButton3Clicked = $timeout(() => {
                    ...
                    Joove.Validation.Manager.validateFormAndExecute(() => {
                        ...
                        //and occurs when the middle mouse button click is triggered
                        var openInNewWindow = $(e.target).data("openInNewWindow") === true || undefined;
                        if (openInNewWindow) $(e.target).data("openInNewWindow", undefined); Joove.Core.executeRedirectControllerAction("ForgotUsername", "Render", "GET", [Joove.Common.nullSafe<any>(() => window["scope_SignInPage"].model.FromMatching, false)], null, null, openInNewWindow);
}, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                }, 0);
            },
            ...
            (e, DataItem, _parents) => {
                ...
                this.timeoutDelayLockButton2Clicked = $timeout(() => {
                    ...
                    Joove.Validation.Manager.validateFormAndExecute(() => {
                        ...
                        //and occurs when the middle mouse button click is triggered
                        var openInNewWindow = $(e.target).data("openInNewWindow") === true || undefined;
                        if (openInNewWindow) $(e.target).data("openInNewWindow", undefined); Joove.Core.executeRedirectControllerAction("ForgotPassword", "Render", "GET", [Joove.Common.nullSafe<any>(() => window["scope_SignInPage"].model.FromMatching, false)], null, null, openInNewWindow);
}, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                }, 0);
            },
...
Button1Clicked:
            (e, DataItem, _parents) => {
                ...
                this.timeoutDelayLockButton1Clicked = $timeout(() => {
                    ...
                    Joove.Validation.Manager.validateFormAndExecute(() => {
                        $scope.actions.SignIn(Joove.Common.nullSafe<any>(() => window["scope_SignInPage"].model.FromMatching, false), null, null, e);
