...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var ProductTypeListConditionalFormattings = [];
        var ProductTypeListDataValidations = [];
        var ProductTypeListCalculatedExpressions = [];
        ...
        var ProductTypeListController = /** @class */ (function () {
            function ProductTypeListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.ProductTypeList.ProductTypeListViewModel._initializeFrom($scope.model, context);
                };
            ...
            ProductTypeListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                    ...
                    AddNewClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockAddNewClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("ProductTypeForm", "Add", "GET", [], null, null, openInNewWindow);
                    ...
                    ModifyClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockModifyClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("ProductTypeForm", "Edit", "GET", [Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItem($("[jb-id='ProductTypeList']"), e).Id; }, 0)], null, null, openInNewWindow);
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
                };
            ...
            return ProductTypeListController;
        }());
        angular.module("Application").controller("ProductTypeListController", ["$scope", "$timeout", ProductTypeListController]);
