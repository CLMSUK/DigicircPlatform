...
interface Window { scope_ManageOperation: DigicircMatchmaking.Controllers.IManageOperationScope; }
...
model:
    DigicircMatchmaking.ViewModels.ManageOperation.ManageOperationViewModel;
...
private timeoutDelayLockButton4Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DigicircMatchmaking.ViewModels.ManageOperation.ManageOperationViewModel._lightCast(window.scope_ManageOperation.model);
    ...
    constructor(private $scope: IManageOperationScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DigicircMatchmaking.ViewModels.ManageOperation.ManageOperationViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IManageOperationScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DigicircMatchmaking.ViewModels.ManageOperation.ManageOperationViewModel._initializeFrom(window.viewDTO.Model);
