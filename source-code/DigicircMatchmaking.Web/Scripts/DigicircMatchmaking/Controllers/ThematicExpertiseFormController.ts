...
interface Window { scope_ThematicExpertiseForm: DigicircMatchmaking.Controllers.IThematicExpertiseFormScope; }
namespace DigicircMatchmaking.Controllers {
const ThematicExpertiseFormConditionalFormattings = [
new Joove.JbRule({
...
condition: async (_parents) => {
        return Joove.Common.nullSafe<any>(() => CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
            return Joove.Common.nullSafe<any>(() => window["scope_ThematicExpertiseForm"].model.Title, "").trim();
        }, "")), false);
...
const ThematicExpertiseFormDataValidations = [
        ];
const ThematicExpertiseFormCalculatedExpressions = [
        ];
...
export interface IThematicExpertiseFormScope extends Joove.IWebPageScope {
model:
    DigicircMatchmaking.ViewModels.ThematicExpertiseForm.ThematicExpertiseFormViewModel;
...
class ThematicExpertiseFormController {
...
private timeoutDelayLockcmdCompanySaveClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        //window.scope_ThematicExpertiseForm.model = window.scope_ThematicExpertiseForm.dehydrate();
        //window.scope_MasterPage.model = window.scope_ThematicExpertiseForm.model;
        DigicircMatchmaking.ViewModels.ThematicExpertiseForm.ThematicExpertiseFormViewModel._lightCast(window.scope_ThematicExpertiseForm.model);
        // Joove.Common.applyScope(window.scope_ThematicExpertiseForm);
        if (resetDirty) {
    ...
    constructor(private $scope: IThematicExpertiseFormScope, $timeout: ng.ITimeoutService) {
        window.scope_ThematicExpertiseForm = $scope;
        $scope.$onControlChanged = function (event, newValue, dontMakeDirty) {
            Joove.Core.onChange(event.target, newValue, dontMakeDirty)
        }

        $scope.dehydrate = (context = null) => DigicircMatchmaking.ViewModels.ThematicExpertiseForm.ThematicExpertiseFormViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IThematicExpertiseFormScope, $timeout: ng.ITimeoutService) {


        $scope.model = DigicircMatchmaking.ViewModels.ThematicExpertiseForm.ThematicExpertiseFormViewModel._initializeFrom(window.viewDTO.Model);
...
Add:
            async (_cb, _modalOptions, _e) => {
                ...
                Joove.Core.executeRedirectControllerAction("ThematicExpertiseForm", "Add", "GET", [], {}, _modalOptions);
            },
Edit:
            async (id, _cb, _modalOptions, _e) => {
                ...
                Joove.Core.executeRedirectControllerAction("ThematicExpertiseForm", "Edit", "GET", [id], {}, _modalOptions);
            },
Save:
            async (_cb, _modalOptions, _e) => {
                Joove.Common.autocompleteFix();
...
verb: 'POST', controller: 'ThematicExpertiseForm', action: 'Save',
...
Delete:
            async (_cb, _modalOptions, _e) => {
                ...
                window._context.isDirty = false;
                Joove.Core.executeControllerActionNew({
verb: 'POST', controller: 'ThematicExpertiseForm', action: 'Delete',
queryData: [], postData: {'model': $scope.model},
cb: _cb, modalOptions: _modalOptions, event: _e
                });
            },
...
// Rules
        window._ruleEngine.addDataValidations(ThematicExpertiseFormDataValidations);
        window._ruleEngine.addConditionalFormattings(ThematicExpertiseFormConditionalFormattings);
        window._ruleEngine.addCalculatedExpressions(ThematicExpertiseFormCalculatedExpressions);
...
angular.module("Application").controller("ThematicExpertiseFormController", ["$scope", "$timeout", ThematicExpertiseFormController] as Array<string>);
}
