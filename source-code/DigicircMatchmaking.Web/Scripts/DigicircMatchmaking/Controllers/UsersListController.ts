...
interface Window { scope_UsersList: DigicircMatchmaking.Controllers.IUsersListScope; }
...
condition: async (_parents) => {
        return Joove.Common.nullSafe<any>(() => CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
            return Joove.Common.nullSafe<any>(() => window["scope_UsersList"].model.Title, "").trim();
        }, "")), false);
...
model:
    DigicircMatchmaking.ViewModels.UsersList.UsersListViewModel;
...
private timeoutDelayLockEditClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DigicircMatchmaking.ViewModels.UsersList.UsersListViewModel._lightCast(window.scope_UsersList.model);
    ...
    constructor(private $scope: IUsersListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DigicircMatchmaking.ViewModels.UsersList.UsersListViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IUsersListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DigicircMatchmaking.ViewModels.UsersList.UsersListViewModel._initializeFrom(window.viewDTO.Model);
