...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var _this = this;
        var ClusterListConditionalFormattings = [
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
                                return Joove.Common.nullSafe(function () { return window["scope_ClusterList"].model.Title; }, "").trim();
                            }, "")); }, false)];
                    });
                }); },
        ...
        var ClusterListDataValidations = [];
        var ClusterListCalculatedExpressions = [];
        ...
        var ClusterListController = /** @class */ (function () {
            function ClusterListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.ClusterList.ClusterListViewModel._initializeFrom($scope.model, context);
                };
            ...
            ClusterListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
        ...
        angular.module("Application").controller("ClusterListController", ["$scope", "$timeout", ClusterListController]);
