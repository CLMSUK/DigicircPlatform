...
interface Window { scope_UnitOfMeasurementForm: DigicircMatchmaking.Controllers.IUnitOfMeasurementFormScope; }
namespace DigicircMatchmaking.Controllers {
const UnitOfMeasurementFormConditionalFormattings = [
new Joove.JbRule({
...
condition: async (_parents) => {
        return Joove.Common.nullSafe<any>(() => CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
            return Joove.Common.nullSafe<any>(() => window["scope_UnitOfMeasurementForm"].model.Title, "").trim();
        }, "")), false);
...
const UnitOfMeasurementFormDataValidations = [
        ];
const UnitOfMeasurementFormCalculatedExpressions = [
        ];
...
export interface IUnitOfMeasurementFormScope extends Joove.IWebPageScope {
model:
    DigicircMatchmaking.ViewModels.UnitOfMeasurementForm.UnitOfMeasurementFormViewModel;
...
class UnitOfMeasurementFormController {
...
private timeoutDelayLockcmdCompanySaveClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        //window.scope_UnitOfMeasurementForm.model = window.scope_UnitOfMeasurementForm.dehydrate();
        //window.scope_SymbiosisMasterPage.model = window.scope_UnitOfMeasurementForm.model;
        DigicircMatchmaking.ViewModels.UnitOfMeasurementForm.UnitOfMeasurementFormViewModel._lightCast(window.scope_UnitOfMeasurementForm.model);
        // Joove.Common.applyScope(window.scope_UnitOfMeasurementForm);
        if (resetDirty) {
    ...
    constructor(private $scope: IUnitOfMeasurementFormScope, $timeout: ng.ITimeoutService) {
        window.scope_UnitOfMeasurementForm = $scope;
        $scope.$onControlChanged = function (event, newValue, dontMakeDirty) {
            Joove.Core.onChange(event.target, newValue, dontMakeDirty)
        }

        $scope.dehydrate = (context = null) => DigicircMatchmaking.ViewModels.UnitOfMeasurementForm.UnitOfMeasurementFormViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IUnitOfMeasurementFormScope, $timeout: ng.ITimeoutService) {


        $scope.model = DigicircMatchmaking.ViewModels.UnitOfMeasurementForm.UnitOfMeasurementFormViewModel._initializeFrom(window.viewDTO.Model);
...
Add:
            async (_cb, _modalOptions, _e) => {
                ...
                Joove.Core.executeRedirectControllerAction("UnitOfMeasurementForm", "Add", "GET", [], {}, _modalOptions);
            },
Edit:
            async (id, _cb, _modalOptions, _e) => {
                ...
                Joove.Core.executeRedirectControllerAction("UnitOfMeasurementForm", "Edit", "GET", [id], {}, _modalOptions);
            },
Save:
            async (_cb, _modalOptions, _e) => {
                Joove.Common.autocompleteFix();
...
verb: 'POST', controller: 'UnitOfMeasurementForm', action: 'Save',
...
Delete:
            async (_cb, _modalOptions, _e) => {
                ...
                window._context.isDirty = false;
                Joove.Core.executeControllerActionNew({
verb: 'POST', controller: 'UnitOfMeasurementForm', action: 'Delete',
queryData: [], postData: {'model': $scope.model},
cb: _cb, modalOptions: _modalOptions, event: _e
                });
            },
...
// Rules
        window._ruleEngine.addDataValidations(UnitOfMeasurementFormDataValidations);
        window._ruleEngine.addConditionalFormattings(UnitOfMeasurementFormConditionalFormattings);
        window._ruleEngine.addCalculatedExpressions(UnitOfMeasurementFormCalculatedExpressions);
...
angular.module("Application").controller("UnitOfMeasurementFormController", ["$scope", "$timeout", UnitOfMeasurementFormController] as Array<string>);
}
