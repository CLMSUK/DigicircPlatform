...
interface Window { scope_PermissionsList: DigicircMatchmaking.Controllers.IPermissionsListScope; }
...
condition: async (_parents) => {
        return Joove.Common.nullSafe<any>(() => CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
            return Joove.Common.nullSafe<any>(() => window["scope_PermissionsList"].model.Title, "").trim();
        }, "")), false);
...
model:
    DigicircMatchmaking.ViewModels.PermissionsList.PermissionsListViewModel;
...
private timeoutDelayLockEditClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DigicircMatchmaking.ViewModels.PermissionsList.PermissionsListViewModel._lightCast(window.scope_PermissionsList.model);
    ...
    constructor(private $scope: IPermissionsListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DigicircMatchmaking.ViewModels.PermissionsList.PermissionsListViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IPermissionsListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DigicircMatchmaking.ViewModels.PermissionsList.PermissionsListViewModel._initializeFrom(window.viewDTO.Model);
