...
interface Window { scope_ApplicationSettingsList: DigicircMatchmaking.Controllers.IApplicationSettingsListScope; }
...
condition: async (_parents) => {
        return Joove.Common.nullSafe<any>(() => CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
            return Joove.Common.nullSafe<any>(() => window["scope_ApplicationSettingsList"].model.Title, "").trim();
        }, "")), false);
...
model:
    DigicircMatchmaking.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel;
...
private timeoutDelayLockEditClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DigicircMatchmaking.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel._lightCast(window.scope_ApplicationSettingsList.model);
    ...
    constructor(private $scope: IApplicationSettingsListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DigicircMatchmaking.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IApplicationSettingsListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DigicircMatchmaking.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel._initializeFrom(window.viewDTO.Model);
