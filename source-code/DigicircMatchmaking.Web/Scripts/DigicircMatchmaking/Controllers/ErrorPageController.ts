...
interface Window { scope_ErrorPage: DigicircMatchmaking.Controllers.IErrorPageScope; }
...
model:
    DigicircMatchmaking.ViewModels.ErrorPage.ErrorPageViewModel;
...
private timeoutDelayLockButtonClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DigicircMatchmaking.ViewModels.ErrorPage.ErrorPageViewModel._lightCast(window.scope_ErrorPage.model);
    ...
    constructor(private $scope: IErrorPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DigicircMatchmaking.ViewModels.ErrorPage.ErrorPageViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IErrorPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DigicircMatchmaking.ViewModels.ErrorPage.ErrorPageViewModel._initializeFrom(window.viewDTO.Model);
