...
interface Window { scope_NotFoundPage: DigicircMatchmaking.Controllers.INotFoundPageScope; }
...
model:
    DigicircMatchmaking.ViewModels.NotFoundPage.NotFoundPageViewModel;
...
private timeoutDelayLockButtonClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DigicircMatchmaking.ViewModels.NotFoundPage.NotFoundPageViewModel._lightCast(window.scope_NotFoundPage.model);
    ...
    constructor(private $scope: INotFoundPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DigicircMatchmaking.ViewModels.NotFoundPage.NotFoundPageViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: INotFoundPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DigicircMatchmaking.ViewModels.NotFoundPage.NotFoundPageViewModel._initializeFrom(window.viewDTO.Model);
