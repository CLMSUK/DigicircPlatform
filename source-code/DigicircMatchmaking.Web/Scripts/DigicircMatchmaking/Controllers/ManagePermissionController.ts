...
interface Window { scope_ManagePermission: DigicircMatchmaking.Controllers.IManagePermissionScope; }
...
model:
    DigicircMatchmaking.ViewModels.ManagePermission.ManagePermissionViewModel;
...
private timeoutDelayLockButton3Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DigicircMatchmaking.ViewModels.ManagePermission.ManagePermissionViewModel._lightCast(window.scope_ManagePermission.model);
    ...
    constructor(private $scope: IManagePermissionScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DigicircMatchmaking.ViewModels.ManagePermission.ManagePermissionViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IManagePermissionScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DigicircMatchmaking.ViewModels.ManagePermission.ManagePermissionViewModel._initializeFrom(window.viewDTO.Model);
