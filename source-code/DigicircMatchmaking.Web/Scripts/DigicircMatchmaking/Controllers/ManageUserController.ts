...
interface Window { scope_ManageUser: DigicircMatchmaking.Controllers.IManageUserScope; }
...
model:
    DigicircMatchmaking.ViewModels.ManageUser.ManageUserViewModel;
_partialModelStructure:
    any;
    _validations?: {
summary: Array<Joove.Validation.BindingEntry>,
UserName: Joove.Validation.BindingEntry,
    },
...
private timeoutDelayLockExitBtnClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DigicircMatchmaking.ViewModels.ManageUser.ManageUserViewModel._lightCast(window.scope_ManageUser.model);
    ...
    constructor(private $scope: IManageUserScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DigicircMatchmaking.ViewModels.ManageUser.ManageUserViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IManageUserScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DigicircMatchmaking.ViewModels.ManageUser.ManageUserViewModel._initializeFrom(window.viewDTO.Model);
