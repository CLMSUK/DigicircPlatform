...
interface Window { scope_EntityTypeForm: DigicircMatchmaking.Controllers.IEntityTypeFormScope; }
namespace DigicircMatchmaking.Controllers {
const EntityTypeFormConditionalFormattings = [
new Joove.JbRule({
...
condition: async (_parents) => {
        return Joove.Common.nullSafe<any>(() => CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
            return Joove.Common.nullSafe<any>(() => window["scope_EntityTypeForm"].model.Title, "").trim();
        }, "")), false);
...
const EntityTypeFormDataValidations = [
                                      ];
const EntityTypeFormCalculatedExpressions = [
        ];
...
export interface IEntityTypeFormScope extends Joove.IWebPageScope {
model:
    DigicircMatchmaking.ViewModels.EntityTypeForm.EntityTypeFormViewModel;
...
class EntityTypeFormController {
...
private timeoutDelayLockcmdCompanySaveClicked:
    ...
    constructor(private $scope: IEntityTypeFormScope, $timeout: ng.ITimeoutService) {
        window.scope_EntityTypeForm = $scope;
        $scope.$onControlChanged = function (event, newValue, dontMakeDirty) {
            Joove.Core.onChange(event.target, newValue, dontMakeDirty)
        }

        $scope.dehydrate = (context = null) => DigicircMatchmaking.ViewModels.EntityTypeForm.EntityTypeFormViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IEntityTypeFormScope, $timeout: ng.ITimeoutService) {
...
angular.module("Application").controller("EntityTypeFormController", ["$scope", "$timeout", EntityTypeFormController] as Array<string>);
}
