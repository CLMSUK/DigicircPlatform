...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var _this = this;
        var MaterialFormConditionalFormattings = [
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
                                return Joove.Common.nullSafe(function () { return window["scope_MaterialForm"].model.Title; }, "").trim();
                            }, "")); }, false)];
                    });
                }); },
            ...
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, !(Joove.Common.nullSafe(function () { return window["scope_MaterialForm"].model.ConvertBy; }, false))];
                    });
                }); },
                evaluationTimes: [Joove.EvaluationTimes.OnLoad, Joove.EvaluationTimes.OnSubmit, Joove.EvaluationTimes.OnChange],
                isRelatedToDataValidation: false
        ...
        var MaterialFormDataValidations = [];
        var MaterialFormCalculatedExpressions = [];
        // Datasets Column Info
        Controllers.ProductTypeDataset_ColumnInfo = [new Joove.ColumnInfo("Name", "string", null, false),
            new Joove.ColumnInfo("original", "ProductType", null, false)];
        window["ProductTypeDataset_ColumnInfo"] = Controllers.ProductTypeDataset_ColumnInfo;
        Controllers.PhysicalFormDataset_ColumnInfo = [new Joove.ColumnInfo("Code", "string", null, false),
            new Joove.ColumnInfo("original", "PhysicalForm", null, false)];
        window["PhysicalFormDataset_ColumnInfo"] = Controllers.PhysicalFormDataset_ColumnInfo;
        Controllers.UnitOfMeasurementDataset_ColumnInfo = [new Joove.ColumnInfo("Code", "string", null, false),
            new Joove.ColumnInfo("original", "UnitOfMeasurement", null, false)];
        window["UnitOfMeasurementDataset_ColumnInfo"] = Controllers.UnitOfMeasurementDataset_ColumnInfo;
        ...
        var MaterialFormController = /** @class */ (function () {
            function MaterialFormController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.MaterialForm.MaterialFormViewModel._initializeFrom($scope.model, context);
                };
            ...
            MaterialFormController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                ...
                $scope.actions = {
                    ...
                    DeleteConvertedByProcess: function (process, _cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            switch (_a.label) {
                                case 0:
                                    ...
                                    implementation = function () { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            Joove.Common.nullSafe(function () { return window["scope_MaterialForm"].model.Material.ConvertedBy.remove(process); }, null);
                                            Joove.Common.nullSafe(function () { return window["scope_MaterialForm"].model.DeleteProcesses.add(process); }, null);
                                            return [2 /*return*/];
                                        });
                                    }); };
                    ...
                    OpenEditConvertByProcess: function (process, _cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        var implementation, spamHelper;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    implementation = function () { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            ...
                                            Joove.Common.nullSafe(function () { return window._commander.showModal("ProcessModal"); }, null);
                                            return [2 /*return*/];
                                        });
                                    }); };
                                    spamHelper = new Joove.SpamControlHelper(_e);
                    ...
                    OpenEditConvertedByProcess: function (process, _cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        var implementation, spamHelper;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                    ...
                    DeleteConvertByProcess: function (process, _cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        var implementation, spamHelper;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    implementation = function () { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            Joove.Common.nullSafe(function () { return window["scope_MaterialForm"].model.Material.ConvertBy.remove(process); }, null);
                                            Joove.Common.nullSafe(function () { return window["scope_MaterialForm"].model.DeleteProcesses.add(process); }, null);
                                            return [2 /*return*/];
                                        });
                                    }); };
                    ...
                    OpenNewConvertedByProcess: function (_cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        var implementation, spamHelper;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    implementation = function () { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            ...
                                            window["scope_MaterialForm"].model.NewProcess = Joove.Common.nullSafe(function () { return new DigicircMatchmaking.BO.Process(); }, null);
                                            Joove.Common.nullSafe(function () { return window["scope_MaterialForm"].model.NewProcess.Product.add(Joove.Common.nullSafe(function () { return window["scope_MaterialForm"].model.Material; }, null)); }, null);
                                            Joove.Common.nullSafe(function () { return window._commander.showModal("ProcessModal"); }, null);
                                            return [2 /*return*/];
                                        });
                                    }); };
                    ...
                    OpenNewConvertByProcess: function (_cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        var implementation, spamHelper;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    implementation = function () { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            ...
                                            window["scope_MaterialForm"].model.Edited = false;
                                            window["scope_MaterialForm"].model.NewProcess = Joove.Common.nullSafe(function () { return new DigicircMatchmaking.BO.Process(); }, null);
                                            Joove.Common.nullSafe(function () { return window["scope_MaterialForm"].model.NewProcess.Source.add(Joove.Common.nullSafe(function () { return window["scope_MaterialForm"].model.Material; }, null)); }, null);
                                            Joove.Common.nullSafe(function () { return window._commander.showModal("ProcessModal"); }, null);
                                            return [2 /*return*/];
                                        });
                                    }); };
                    ...
                    AddNewProcess: function (_cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        var implementation, spamHelper;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    implementation = function () { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            if ((Joove.Common.nullSafe(function () { return window["scope_MaterialForm"].model.Edited; }, false))) {
                                                Joove.Common.nullSafe(function () { return window["scope_MaterialForm"].model.EditedProcesses.add(Joove.Common.nullSafe(function () { return window["scope_MaterialForm"].model.NewProcess; }, null)); }, null);
                                                if ((Joove.Common.nullSafe(function () { return window["scope_MaterialForm"].model.ConvertBy; }, false))) {
                                                    Joove.Common.nullSafe(function () { return window._commander.gridRefresh(["Table"]); }, null);
                                                }
                                                else {
                                                    Joove.Common.nullSafe(function () { return window._commander.gridRefresh(["Table1"]); }, null);
                                                }
                                            }
                                            else {
                                                if ((Joove.Common.nullSafe(function () { return window["scope_MaterialForm"].model.ConvertBy; }, false))) {
                                                    Joove.Common.nullSafe(function () { return window["scope_MaterialForm"].model.Material.ConvertBy.add(Joove.Common.nullSafe(function () { return window["scope_MaterialForm"].model.NewProcess; }, null)); }, null);
                                                }
                                                else {
                                                    Joove.Common.nullSafe(function () { return window["scope_MaterialForm"].model.Material.ConvertedBy.add(Joove.Common.nullSafe(function () { return window["scope_MaterialForm"].model.NewProcess; }, null)); }, null);
                                                }
                                                Joove.Common.nullSafe(function () { return window["scope_MaterialForm"].model.NewProcesses.add(Joove.Common.nullSafe(function () { return window["scope_MaterialForm"].model.NewProcess; }, null)); }, null);
                                            }
                                            Joove.Common.nullSafe(function () { return window._commander.hideModal("ProcessModal"); }, null);
                                            return [2 /*return*/];
                                        });
                                    }); };
                                    spamHelper = new Joove.SpamControlHelper(_e);
            ...
            return MaterialFormController;
        }());
        angular.module("Application").controller("MaterialFormController", ["$scope", "$timeout", MaterialFormController]);
