...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var EntityTypeListConditionalFormattings = [];
        var EntityTypeListDataValidations = [];
        var EntityTypeListCalculatedExpressions = [];
        ...
        var EntityTypeListController = /** @class */ (function () {
            function EntityTypeListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.EntityTypeList.EntityTypeListViewModel._initializeFrom($scope.model, context);
                };
            ...
            EntityTypeListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                    ...
                    AddClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockAddClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("EntityTypeForm", "Add", "GET", [], null, null, openInNewWindow);
                    ...
                    EditClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockEditClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("EntityTypeForm", "Edit", "GET", [Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItem($("[jb-id='EntityTypeList']"), e).Id; }, 0)], null, null, openInNewWindow);
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
                };
        ...
        angular.module("Application").controller("EntityTypeListController", ["$scope", "$timeout", EntityTypeListController]);
