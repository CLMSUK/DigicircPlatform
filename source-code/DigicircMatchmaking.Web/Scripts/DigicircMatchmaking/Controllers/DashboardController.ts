...
interface Window { scope_Dashboard: DigicircMatchmaking.Controllers.IDashboardScope; }
...
model:
    DigicircMatchmaking.ViewModels.Dashboard.DashboardViewModel;
...
class DashboardController {
    ...
    constructor(private $scope: IDashboardScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DigicircMatchmaking.ViewModels.Dashboard.DashboardViewModel._initializeFrom($scope.model, context);
