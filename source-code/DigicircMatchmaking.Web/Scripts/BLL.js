    ...
    (function (BO) {
        ...
        var Address = /** @class */ (function () {
            ...
            Address.GetFullAddress = function ($this) {
                return Joove.Common.nullSafe(function () { return $this.StreetName; }, "") + " " + Joove.Common.nullSafe(function () { return $this.Number; }, "") + ",<br />" + Joove.Common.nullSafe(function () { return $this.Town; }, "") + " " + Joove.Common.nullSafe(function () { return $this.Zip; }, "") + "<br />" + Joove.Common.nullSafe(function () { return $this.Country.Name; }, "");
            };
        ...
        var Process = /** @class */ (function () {
            ...
            Process.GetEnvironmentalEffects = function ($this) {
                if ((CLMS.Framework.Number.LessThan(function () { return $this.EnvironmentalEffects.length; }, function () { return 50; }))) {
                    return Joove.Common.nullSafe(function () { return $this.EnvironmentalEffects; }, "");
                }
                else {
                    return Joove.Common.nullSafe(function () { return $this.EnvironmentalEffects.substring(0, 50); }, "") + "...";
                }
            };
        ...
        var ElasticDoc = /** @class */ (function () {
            ...
            ElasticDoc.CreateActorDoc = function (actor) {
                ...
                if ((CLMS.Framework.Number.GreaterThan(function () { return actor.CircularEconomyRequirements.DesiredResources.length; }, function () { return 0; }))) {
                    Joove.Common.nullSafe(function () { return requestedMaterial.addRange(Joove.Common.nullSafe(function () { return actor.CircularEconomyRequirements.DesiredResources.linq.select(function (m) { return Joove.Common.nullSafe(function () { return m.Resource.Name; }, ""); }).toArray(); }, null)); }, null);
                }
        ...
        var ElasticConsumer = /** @class */ (function () {
            ...
            ElasticConsumer.Filters = function (modelQuery, filterResource) {
                ...
                if ((filterResource && Joove.Common.nullSafe(function () { return modelQuery.SelectedMaterial.Name; }, "") != null)) {
                    ...
                    var materialSearchMode = "";
                    switch (Joove.Common.nullSafe(function () { return modelQuery.MaterialSearchMode; }, "")) {
                        case "offers": {
        ...
        BO.Match = Match;
        var ActorsInfo = /** @class */ (function () {
            function ActorsInfo() {
                this._originalTypeClassName = "DigicircMatchmaking.BO.ActorsInfo";
                this.Domain = DigicircMatchmaking.BO;
                this['_key'] = this.ActorsInfoKey = 0;
            }
            ActorsInfo.IsNew = function ($this) {
                if ($this == null)
                    return true;
        ...
        var SuggestionsFlowContext = /** @class */ (function (_super) {
            __extends(SuggestionsFlowContext, _super);
            function SuggestionsFlowContext() {
                var _this = _super.call(this) || this;
                _this._originalTypeClassName = "DigicircMatchmaking.BO.SuggestionsFlowContext";
                _this.Domain = DigicircMatchmaking.BO;
                _this['_key'] = _this.Id = "00000000-0000-0000-0000-000000000000";
                return _this;
            }
            SuggestionsFlowContext.IsNew = function ($this) {
                if ($this == null)
                    return true;
                return $this.Id == null || $this.Id == "00000000-0000-0000-0000-000000000000";
            };
            return SuggestionsFlowContext;
        }(WorkflowContextBase));
        BO.SuggestionsFlowContext = SuggestionsFlowContext;
