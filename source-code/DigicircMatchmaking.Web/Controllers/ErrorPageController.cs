...
using DigicircMatchmaking.UI.ViewModels.ErrorPage;
...
namespace DigicircMatchmaking.UI.Controllers.ErrorPage
{
    ...
    public class ErrorPageController : ControllerBase<ErrorPageViewModel, ErrorPageViewModelDTO>
    {
        ...
        public ErrorPageController SetModel(ErrorPageViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        public ActionResult ExecuteSendErrorToAdministrator()
        {
            ...
            mail.Subject = "DigicircMatchmaking" + " threw an Exception";
