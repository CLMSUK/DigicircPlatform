...
using DigicircMatchmaking.UI.ViewModels.ManageOperation;
...
namespace DigicircMatchmaking.UI.Controllers.ManageOperation
{
    ...
    public class ManageOperationController : ControllerBase<ManageOperationViewModel, ManageOperationViewModelDTO>
    {
        ...
        public ManageOperationController SetModel(ManageOperationViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        public ActionResult ExecuteEditOperation(int? Id)
        {
            ...
            @model.ApplicationOperation =  new DigicircMatchmaking.DAL.Repository().GetById<zAppDev.DotNet.Framework.Identity.Model.ApplicationOperation>(Id);
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().Save<zAppDev.DotNet.Framework.Identity.Model.ApplicationOperation>(@model.ApplicationOperation);
            _result = CloseForm();
            return _result;
        }
        #endregion
        ...
        public JsonResult Button2_PickList_Datasource()
        {
            ...
            if (datasourceRequest.GroupBy.Any())
            {
                ...
                response.Data = items.ToList().Select(i => new Button2DataSet_ApplicationPermissionDTO(i, true)).ToList();
