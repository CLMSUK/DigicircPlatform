...
using DigicircMatchmaking.UI.ViewModels.OportunitiesExplorer;
...
namespace DigicircMatchmaking.UI.Controllers.OportunitiesExplorer
{

    [RoutePrefix("OportunitiesExplorer")]
    public class OportunitiesExplorerController : ControllerBase<OportunitiesExplorerViewModel, OportunitiesExplorerViewModelDTO>
    {

        /*<Form:OportunitiesExplorer:0/>*/
        public OportunitiesExplorerController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(OportunitiesExplorerController));
        ...
        public OportunitiesExplorerController SetModel(OportunitiesExplorerViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(OportunitiesExplorerViewModel));
        }
        ...
        {
            @model = new OportunitiesExplorerViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_OportunitiesExplorer"] = "Index";
            return null;
        }
        ...
        public ActionResult ExecuteIndex()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("OportunitiesExplorer", "RES_PAGETITLE_Index").ToString();
            return _result;
        }
        #endregion
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new OportunitiesExplorerViewModelDTO(@model);
            ...
            return View("OportunitiesExplorer");
        }
        ...
        private ActionResult GetFailedDataValidationsResult(List<string> groupsToCheck = null)
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: OportunitiesExplorer, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
