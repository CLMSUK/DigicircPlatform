...
using DigicircMatchmaking.UI.ViewModels.ServicesForm;
...
namespace DigicircMatchmaking.UI.Controllers.ServicesForm
{

    [RoutePrefix("ServicesForm")]
    public class ServicesFormController : ControllerBase<ServicesFormViewModel, ServicesFormViewModelDTO>
    {

        /*<Form:ServicesForm:0/>*/
        public ServicesFormController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(ServicesFormController));
        ...
        public ServicesFormController SetModel(ServicesFormViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(ServicesFormViewModel));
        }
        ...
        {
            @model = new ServicesFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_ServicesForm"] = "Add";
            return null;
        }
        ...
        {
            @model = new ServicesFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_ServicesForm"] = "Edit";
            return null;
        }
        ...
        public ActionResult ExecuteAdd()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("ServicesForm", "RES_PAGETITLE_Add").ToString();
            return _result;
        }
        ...
        public ActionResult ExecuteEdit(int? id)
        {
            ...
            ((MasterPage.MasterPageController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.Services =  new DigicircMatchmaking.DAL.Repository().GetById<DigicircMatchmaking.BO.Services>(id);
            @model.Title = BaseViewPage<string>.GetResourceValue("ServicesForm", "RES_PAGETITLE_Edit").ToString();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().Save<DigicircMatchmaking.BO.Services>(@model.Services);
            _result = CloseForm();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().DeleteServices(@model.Services);
            _result = CloseForm();
            return _result;
        }
        #endregion
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new ServicesFormViewModelDTO(@model);
        ...
        private ActionResult GetFailedDataValidationsResult(List<string> groupsToCheck = null)
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: ServicesForm, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
