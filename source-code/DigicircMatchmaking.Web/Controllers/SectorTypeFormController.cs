...
using DigicircMatchmaking.UI.ViewModels.SectorTypeForm;
...
namespace DigicircMatchmaking.UI.Controllers.SectorTypeForm
{

    [RoutePrefix("SectorTypeForm")]
    public class SectorTypeFormController : ControllerBase<SectorTypeFormViewModel, SectorTypeFormViewModelDTO>
    {

        /*<Form:SectorTypeForm:0/>*/
        public SectorTypeFormController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(SectorTypeFormController));
        ...
        public SectorTypeFormController SetModel(SectorTypeFormViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(SectorTypeFormViewModel));
        }
        ...
        {
            @model = new SectorTypeFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_SectorTypeForm"] = "Add";
            return null;
        }
        ...
        {
            @model = new SectorTypeFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_SectorTypeForm"] = "Edit";
            return null;
        }
        ...
        public ActionResult ExecuteAdd()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("SectorTypeForm", "RES_PAGETITLE_Add").ToString();
            return _result;
        }
        ...
        public ActionResult ExecuteEdit(int? id)
        {
            ...
            ((MasterPage.MasterPageController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.SectorType =  new DigicircMatchmaking.DAL.Repository().GetById<DigicircMatchmaking.BO.SectorType>(id);
            @model.Title = BaseViewPage<string>.GetResourceValue("SectorTypeForm", "RES_PAGETITLE_Edit").ToString();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().Save<DigicircMatchmaking.BO.SectorType>(@model.SectorType);
            _result = GetRedirectInfo("SectorTypeList", "Index", new  RouteValueDictionary(new {  }));
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().DeleteSectorType(@model.SectorType);
            _result = CloseForm();
            return _result;
        }
        #endregion
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new SectorTypeFormViewModelDTO(@model);
        ...
        private ActionResult GetFailedDataValidationsResult(List<string> groupsToCheck = null)
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: SectorTypeForm, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
