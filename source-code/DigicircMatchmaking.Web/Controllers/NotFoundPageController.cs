...
using DigicircMatchmaking.UI.ViewModels.NotFoundPage;
...
namespace DigicircMatchmaking.UI.Controllers.NotFoundPage
{
    ...
    public class NotFoundPageController : ControllerBase<NotFoundPageViewModel, NotFoundPageViewModelDTO>
    {
        ...
        public NotFoundPageController SetModel(NotFoundPageViewModel m)
        {
            @model = m;
            return this;
        }
