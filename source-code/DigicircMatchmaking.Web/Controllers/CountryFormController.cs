...
using DigicircMatchmaking.UI.ViewModels.CountryForm;
...
namespace DigicircMatchmaking.UI.Controllers.CountryForm
{

    [RoutePrefix("CountryForm")]
    public class CountryFormController : ControllerBase<CountryFormViewModel, CountryFormViewModelDTO>
    {

        /*<Form:CountryForm:0/>*/
        public CountryFormController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(CountryFormController));
        ...
        public CountryFormController SetModel(CountryFormViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(CountryFormViewModel));
        }
        ...
        {
            @model = new CountryFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_CountryForm"] = "Add";
            return null;
        }
        ...
        {
            @model = new CountryFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_CountryForm"] = "Edit";
            return null;
        }
        ...
        public ActionResult ExecuteAdd()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("CountryForm", "RES_PAGETITLE_Add").ToString();
            return _result;
        }
        ...
        public ActionResult ExecuteEdit(int? id)
        {
            ...
            ((MasterPage.MasterPageController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.Country =  new DigicircMatchmaking.DAL.Repository().GetById<DigicircMatchmaking.BO.Country>(id);
            @model.Title = BaseViewPage<string>.GetResourceValue("CountryForm", "RES_PAGETITLE_Edit").ToString();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().Save<DigicircMatchmaking.BO.Country>(@model.Country);
            _result = CloseForm();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().DeleteCountry(@model.Country);
            _result = CloseForm();
            return _result;
        }
        #endregion
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new CountryFormViewModelDTO(@model);
        ...
        private ActionResult GetFailedDataValidationsResult(List<string> groupsToCheck = null)
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: CountryForm, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
