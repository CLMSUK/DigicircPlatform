...
using DigicircMatchmaking.UI.ViewModels.ProcessForm;
...
namespace DigicircMatchmaking.UI.Controllers.ProcessForm
{

    [RoutePrefix("ProcessForm")]
    public class ProcessFormController : ControllerBase<ProcessFormViewModel, ProcessFormViewModelDTO>
    {

        /*<Form:ProcessForm:0/>*/
        public ProcessFormController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(ProcessFormController));
        ...
        public ProcessFormController SetModel(ProcessFormViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(ProcessFormViewModel));
        }
        ...
        {
            @model = new ProcessFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_ProcessForm"] = "Add";
            return null;
        }
        ...
        {
            @model = new ProcessFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_ProcessForm"] = "Edit";
            return null;
        }
        ...
        public ActionResult ExecuteAdd()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("ProcessForm", "RES_PAGETITLE_Add").ToString();
            return _result;
        }
        ...
        public ActionResult ExecuteEdit(int? id)
        {
            ...
            ((SymbiosisMasterPage.SymbiosisMasterPageController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.Process =  new DigicircMatchmaking.DAL.Repository().GetById<DigicircMatchmaking.BO.Process>(id);
            @model.Title = BaseViewPage<string>.GetResourceValue("ProcessForm", "RES_PAGETITLE_Edit").ToString();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().Save<DigicircMatchmaking.BO.Process>(@model.Process);
            if ((zAppDev.DotNet.Framework.Utilities.Web.IsInControllerAction("Add")))
            {
                DigicircMatchmaking.BO.ProcessBackendExtensions.CreateKnowledgeProcess(@model.Process);
            }
            else
            {
                DigicircMatchmaking.BO.ProcessBackendExtensions.UpdateKnowledgeProcess(@model.Process);
            }
            _result = CloseForm();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().DeleteProcess(@model.Process);
            DigicircMatchmaking.BO.ProcessBackendExtensions.DeleteKnowledgeProcess(@model.Process);
            _result = CloseForm();
            return _result;
        }
        #endregion
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new ProcessFormViewModelDTO(@model);
        ...
        private ActionResult GetFailedDataValidationsResult(List<string> groupsToCheck = null)
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: ProcessForm, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
