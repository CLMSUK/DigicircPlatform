...
using DigicircMatchmaking.UI.ViewModels.UnitOfMeasurementForm;
...
namespace DigicircMatchmaking.UI.Controllers.UnitOfMeasurementForm
{

    [RoutePrefix("UnitOfMeasurementForm")]
    public class UnitOfMeasurementFormController : ControllerBase<UnitOfMeasurementFormViewModel, UnitOfMeasurementFormViewModelDTO>
    {

        /*<Form:UnitOfMeasurementForm:0/>*/
        public UnitOfMeasurementFormController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(UnitOfMeasurementFormController));
        ...
        public UnitOfMeasurementFormController SetModel(UnitOfMeasurementFormViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(UnitOfMeasurementFormViewModel));
        }
        ...
        {
            @model = new UnitOfMeasurementFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_UnitOfMeasurementForm"] = "Add";
            return null;
        }
        ...
        {
            @model = new UnitOfMeasurementFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_UnitOfMeasurementForm"] = "Edit";
            return null;
        }
        ...
        public ActionResult ExecuteAdd()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("UnitOfMeasurementForm", "RES_PAGETITLE_Add").ToString();
            return _result;
        }
        ...
        public ActionResult ExecuteEdit(int? id)
        {
            ...
            ((SymbiosisMasterPage.SymbiosisMasterPageController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.UnitOfMeasurement =  new DigicircMatchmaking.DAL.Repository().GetById<DigicircMatchmaking.BO.UnitOfMeasurement>(id);
            @model.Title = BaseViewPage<string>.GetResourceValue("UnitOfMeasurementForm", "RES_PAGETITLE_Edit").ToString();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().Save<DigicircMatchmaking.BO.UnitOfMeasurement>(@model.UnitOfMeasurement);
            _result = CloseForm();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().DeleteUnitOfMeasurement(@model.UnitOfMeasurement);
            _result = CloseForm();
            return _result;
        }
        #endregion
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new UnitOfMeasurementFormViewModelDTO(@model);
            ...
            return View("UnitOfMeasurementForm");
        }
        ...
        private ActionResult GetFailedDataValidationsResult(List<string> groupsToCheck = null)
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: UnitOfMeasurementForm, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
