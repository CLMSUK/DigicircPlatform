...
using DigicircMatchmaking.UI.ViewModels.UnderContructionPage;
...
namespace DigicircMatchmaking.UI.Controllers.UnderContructionPage
{

    [RoutePrefix("UnderContructionPage")]
    public class UnderContructionPageController : ControllerBase<UnderContructionPageViewModel, UnderContructionPageViewModelDTO>
    {

        /*<Form:UnderContructionPage:0/>*/
        public UnderContructionPageController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(UnderContructionPageController));
        ...
        public UnderContructionPageController SetModel(UnderContructionPageViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(UnderContructionPageViewModel));
        }
        ...
        {
            @model = new UnderContructionPageViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_UnderContructionPage"] = "Index";
            return null;
        }
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new UnderContructionPageViewModelDTO(@model);
            ...
            return View("UnderContructionPage");
        }
        ...
        private ActionResult GetFailedDataValidationsResult(List<string> groupsToCheck = null)
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: UnderContructionPage, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
