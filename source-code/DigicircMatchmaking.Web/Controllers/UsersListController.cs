...
using DigicircMatchmaking.UI.ViewModels.UsersList;
...
namespace DigicircMatchmaking.UI.Controllers.UsersList
{
    ...
    public class UsersListController : ControllerBase<UsersListViewModel, UsersListViewModelDTO>
    {
        ...
        public UsersListController SetModel(UsersListViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        public JsonResult List_Datasource()
        {
            ...
            if (datasourceRequest.GroupBy.Any())
            {
                ...
                response.Data = items.ToList().Select(i => new List1DataSet_ApplicationUserDTO(i, true)).ToList();
...
//Fix for total items in GetGroupsClosed
        ...
        public string List_ExportV2Implementation(DatasourceRequest datasourceRequest,
                ExportOptionsV2 exportOptions, List<AggregatorInfo<zAppDev.DotNet.Framework.Identity.Model.ApplicationUser>> aggregatorsInfo,
