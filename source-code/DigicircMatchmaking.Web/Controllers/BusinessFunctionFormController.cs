...
using DigicircMatchmaking.UI.ViewModels.BusinessFunctionForm;
...
namespace DigicircMatchmaking.UI.Controllers.BusinessFunctionForm
{

    [RoutePrefix("BusinessFunctionForm")]
    public class BusinessFunctionFormController : ControllerBase<BusinessFunctionFormViewModel, BusinessFunctionFormViewModelDTO>
    {

        /*<Form:BusinessFunctionForm:0/>*/
        public BusinessFunctionFormController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(BusinessFunctionFormController));
        ...
        public BusinessFunctionFormController SetModel(BusinessFunctionFormViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(BusinessFunctionFormViewModel));
        }
        ...
        {
            @model = new BusinessFunctionFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_BusinessFunctionForm"] = "Add";
            return null;
        }
        ...
        {
            @model = new BusinessFunctionFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_BusinessFunctionForm"] = "Edit";
            return null;
        }
        ...
        public ActionResult ExecuteAdd()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("BusinessFunctionForm", "RES_PAGETITLE_Add").ToString();
            return _result;
        }
        ...
        public ActionResult ExecuteEdit(int? id)
        {
            ...
            ((MasterPage.MasterPageController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.BusinessFunction =  new DigicircMatchmaking.DAL.Repository().GetById<DigicircMatchmaking.BO.BusinessFunction>(id);
            @model.Title = BaseViewPage<string>.GetResourceValue("BusinessFunctionForm", "RES_PAGETITLE_Edit").ToString();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().Save<DigicircMatchmaking.BO.BusinessFunction>(@model.BusinessFunction);
            _result = CloseForm();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().DeleteBusinessFunction(@model.BusinessFunction);
            _result = CloseForm();
            return _result;
        }
        #endregion
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new BusinessFunctionFormViewModelDTO(@model);
            ...
            return View("BusinessFunctionForm");
        }
        ...
        private ActionResult GetFailedDataValidationsResult(List<string> groupsToCheck = null)
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: BusinessFunctionForm, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
