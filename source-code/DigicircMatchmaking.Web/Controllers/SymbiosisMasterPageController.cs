...
namespace DigicircMatchmaking.UI.Controllers.SymbiosisMasterPage
{

    [RoutePrefix("SymbiosisMasterPage")]
    public class SymbiosisMasterPageController : ControllerBase<SymbiosisMasterPageViewModel, SymbiosisMasterPageViewModelDTO>
    {
        public SymbiosisMasterPageController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(SymbiosisMasterPageController));
            if (ViewModelDTOBase.DTOHelper == null)
            {
                ViewModelDTOBase.DTOHelper = new DTOHelper();
            }
        }
        public SymbiosisMasterPageController(SymbiosisMasterPageViewModel m) : this()
        {
            model = m;
        }

        public SymbiosisMasterPageController SetModel(SymbiosisMasterPageViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(SymbiosisMasterPageViewModel));
        }
        ...
        [Route("_GetDbErrors")]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "_GetDbErrors")]
        ...
        [Route("_Ping")]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "_Ping")]
        ...
        {
            @model = new SymbiosisMasterPageViewModel();
            return null;
        }
        ...
        public ActionResult ExecuteRender()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("SymbiosisMasterPage", "RES_PAGETITLE_Render").ToString();
        ...
        public ActionResult ExecuteSignOut()
        {
            ...
            _result = GetRedirectInfo("SignInPage", "Load", new  RouteValueDictionary(new { fromMatching = false }));
            return _result;
        }
        #endregion
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new SymbiosisMasterPageViewModelDTO(@model);
            ...
            return View("SymbiosisMasterPage");
        }
        ...
        private ActionResult GetFailedDataValidationsResult(List<string> groupsToCheck = null)
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: SymbiosisMasterPage, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
