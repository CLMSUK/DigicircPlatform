...
using DigicircMatchmaking.UI.ViewModels.ClusterInitialization;
...
namespace DigicircMatchmaking.UI.Controllers.ClusterInitialization
{

    [RoutePrefix("ClusterInitialization")]
    public class ClusterInitializationController : ControllerBase<ClusterInitializationViewModel, ClusterInitializationViewModelDTO>
    {

        /*<Form:ClusterInitialization:0/>*/
        public ClusterInitializationController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(ClusterInitializationController));
        ...
        public ClusterInitializationController SetModel(ClusterInitializationViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(ClusterInitializationViewModel));
        }
        ...
        {
            @model = new ClusterInitializationViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_ClusterInitialization"] = "Index";
            return null;
        }
        ...
        public ActionResult ExecuteIndex()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("ClusterInitialization", "RES_PAGETITLE_Index").ToString();
            return _result;
        }
        ...
        public ActionResult ExecuteSave()
        {
            ...
            {
                zAppDev.DotNet.Framework.Utilities.DebugHelper.Log(zAppDev.DotNet.Framework.Utilities.DebugMessageType.Error, "ClusterInitialization", DigicircMatchmaking.Hubs.EventsHub.RaiseDebugMessage, x);
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new ClusterInitializationViewModelDTO(@model);
            ...
            return View("ClusterInitialization");
        }
        ...
        private ActionResult GetFailedDataValidationsResult(List<string> groupsToCheck = null)
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: ClusterInitialization, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
