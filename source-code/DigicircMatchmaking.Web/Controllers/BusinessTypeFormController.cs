...
using DigicircMatchmaking.UI.ViewModels.BusinessTypeForm;
...
namespace DigicircMatchmaking.UI.Controllers.BusinessTypeForm
{

    [RoutePrefix("BusinessTypeForm")]
    public class BusinessTypeFormController : ControllerBase<BusinessTypeFormViewModel, BusinessTypeFormViewModelDTO>
    {

        /*<Form:BusinessTypeForm:0/>*/
        public BusinessTypeFormController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(BusinessTypeFormController));
        ...
        public BusinessTypeFormController SetModel(BusinessTypeFormViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(BusinessTypeFormViewModel));
        }
        ...
        {
            @model = new BusinessTypeFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_BusinessTypeForm"] = "Add";
            return null;
        }
        ...
        {
            @model = new BusinessTypeFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_BusinessTypeForm"] = "Edit";
            return null;
        }
        ...
        public ActionResult ExecuteAdd()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("BusinessTypeForm", "RES_PAGETITLE_Add").ToString();
            return _result;
        }
        ...
        public ActionResult ExecuteEdit(int? id)
        {
            ...
            ((MasterPage.MasterPageController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.BusinessType =  new DigicircMatchmaking.DAL.Repository().GetById<DigicircMatchmaking.BO.BusinessType>(id);
            @model.Title = BaseViewPage<string>.GetResourceValue("BusinessTypeForm", "RES_PAGETITLE_Edit").ToString();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().Save<DigicircMatchmaking.BO.BusinessType>(@model.BusinessType);
            _result = CloseForm();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().DeleteBusinessType(@model.BusinessType);
            _result = CloseForm();
            return _result;
        }
        #endregion
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new BusinessTypeFormViewModelDTO(@model);
        ...
        private ActionResult GetFailedDataValidationsResult(List<string> groupsToCheck = null)
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: BusinessTypeForm, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
