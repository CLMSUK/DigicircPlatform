...
using DigicircMatchmaking.UI.ViewModels.PhysicalFormForm;
...
namespace DigicircMatchmaking.UI.Controllers.PhysicalFormForm
{

    [RoutePrefix("PhysicalFormForm")]
    public class PhysicalFormFormController : ControllerBase<PhysicalFormFormViewModel, PhysicalFormFormViewModelDTO>
    {

        /*<Form:PhysicalFormForm:0/>*/
        public PhysicalFormFormController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(PhysicalFormFormController));
        ...
        public PhysicalFormFormController SetModel(PhysicalFormFormViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(PhysicalFormFormViewModel));
        }
        ...
        {
            @model = new PhysicalFormFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_PhysicalFormForm"] = "Add";
            return null;
        }
        ...
        {
            @model = new PhysicalFormFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_PhysicalFormForm"] = "Edit";
            return null;
        }
        ...
        public ActionResult ExecuteAdd()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("PhysicalFormForm", "RES_PAGETITLE_Add").ToString();
            return _result;
        }
        ...
        public ActionResult ExecuteEdit(int? id)
        {
            ...
            ((SymbiosisMasterPage.SymbiosisMasterPageController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.PhysicalForm =  new DigicircMatchmaking.DAL.Repository().GetById<DigicircMatchmaking.BO.PhysicalForm>(id);
            @model.Title = BaseViewPage<string>.GetResourceValue("PhysicalFormForm", "RES_PAGETITLE_Edit").ToString();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().Save<DigicircMatchmaking.BO.PhysicalForm>(@model.PhysicalForm);
            _result = CloseForm();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().DeletePhysicalForm(@model.PhysicalForm);
            _result = CloseForm();
            return _result;
        }
        #endregion
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new PhysicalFormFormViewModelDTO(@model);
        ...
        private ActionResult GetFailedDataValidationsResult(List<string> groupsToCheck = null)
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: PhysicalFormForm, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
