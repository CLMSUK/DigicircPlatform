...
using DigicircMatchmaking.UI.ViewModels.About;
...
namespace DigicircMatchmaking.UI.Controllers.About
{

    [RoutePrefix("About")]
    public class AboutController : ControllerBase<AboutViewModel, AboutViewModelDTO>
    {

        /*<Form:About:0/>*/
        public AboutController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(AboutController));
        ...
        public AboutController SetModel(AboutViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(AboutViewModel));
        }
...

        {
            ...
            System.Web.HttpContext.Current.Session["LastEntryPoint_About"] = "Index";
            return null;
        }
        ...
        public ActionResult ExecuteIndex()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("About", "RES_PAGETITLE_Index").ToString();
            return _result;
        }
        #endregion
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new AboutViewModelDTO(@model);
        ...
        private ActionResult GetFailedDataValidationsResult(List<string> groupsToCheck = null)
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: About, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
