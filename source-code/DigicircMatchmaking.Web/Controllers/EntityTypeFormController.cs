...
using DigicircMatchmaking.UI.ViewModels.EntityTypeForm;
...
namespace DigicircMatchmaking.UI.Controllers.EntityTypeForm
{

    [RoutePrefix("EntityTypeForm")]
    public class EntityTypeFormController : ControllerBase<EntityTypeFormViewModel, EntityTypeFormViewModelDTO>
    {

        /*<Form:EntityTypeForm:0/>*/
        public EntityTypeFormController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(EntityTypeFormController));
        ...
        public EntityTypeFormController SetModel(EntityTypeFormViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(EntityTypeFormViewModel));
        }
        ...
        {
            @model = new EntityTypeFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_EntityTypeForm"] = "Add";
            return null;
        }
        ...
        {
            @model = new EntityTypeFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_EntityTypeForm"] = "Edit";
            return null;
        }
        ...
        public ActionResult ExecuteAdd()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("EntityTypeForm", "RES_PAGETITLE_Add").ToString();
            return _result;
        }
        ...
        public ActionResult ExecuteEdit(int? id)
        {
            ...
            ((MasterPage.MasterPageController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.EntityType =  new DigicircMatchmaking.DAL.Repository().GetById<DigicircMatchmaking.BO.EntityType>(id);
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().Save<DigicircMatchmaking.BO.EntityType>(@model.EntityType);
            _result = CloseForm();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().DeleteEntityType(@model.EntityType);
            _result = CloseForm();
            return _result;
        }
        #endregion
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new EntityTypeFormViewModelDTO(@model);
        ...
        private ActionResult GetFailedDataValidationsResult(List<string> groupsToCheck = null)
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: EntityTypeForm, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
