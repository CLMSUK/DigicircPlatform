...
using DigicircMatchmaking.UI.ViewModels.ThematicExpertiseForm;
...
namespace DigicircMatchmaking.UI.Controllers.ThematicExpertiseForm
{

    [RoutePrefix("ThematicExpertiseForm")]
    public class ThematicExpertiseFormController : ControllerBase<ThematicExpertiseFormViewModel, ThematicExpertiseFormViewModelDTO>
    {

        /*<Form:ThematicExpertiseForm:0/>*/
        public ThematicExpertiseFormController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(ThematicExpertiseFormController));
        ...
        public ThematicExpertiseFormController SetModel(ThematicExpertiseFormViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(ThematicExpertiseFormViewModel));
        }
        ...
        {
            @model = new ThematicExpertiseFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_ThematicExpertiseForm"] = "Add";
            return null;
        }
        ...
        {
            @model = new ThematicExpertiseFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_ThematicExpertiseForm"] = "Edit";
            return null;
        }
        ...
        public ActionResult ExecuteAdd()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("ThematicExpertiseForm", "RES_PAGETITLE_Add").ToString();
            return _result;
        }
        ...
        public ActionResult ExecuteEdit(int? id)
        {
            ...
            ((MasterPage.MasterPageController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.ThematicExpertise =  new DigicircMatchmaking.DAL.Repository().GetById<DigicircMatchmaking.BO.ThematicExpertise>(id);
            @model.Title = BaseViewPage<string>.GetResourceValue("ThematicExpertiseForm", "RES_PAGETITLE_Edit").ToString();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().Save<DigicircMatchmaking.BO.ThematicExpertise>(@model.ThematicExpertise);
            _result = CloseForm();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().DeleteThematicExpertise(@model.ThematicExpertise);
            _result = CloseForm();
            return _result;
        }
        #endregion
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new ThematicExpertiseFormViewModelDTO(@model);
            ...
            return View("ThematicExpertiseForm");
        }
        ...
        private ActionResult GetFailedDataValidationsResult(List<string> groupsToCheck = null)
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: ThematicExpertiseForm, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
