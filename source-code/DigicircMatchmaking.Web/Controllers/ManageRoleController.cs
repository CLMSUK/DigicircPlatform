...
using DigicircMatchmaking.UI.ViewModels.ManageRole;
...
namespace DigicircMatchmaking.UI.Controllers.ManageRole
{
    ...
    public class ManageRoleController : ControllerBase<ManageRoleViewModel, ManageRoleViewModelDTO>
    {
        ...
        public ManageRoleController SetModel(ManageRoleViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        public ActionResult ExecuteEditRole(int? Id)
        {
            ...
            ((MasterPageForSlide.MasterPageForSlideController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.ApplicationRole =  new DigicircMatchmaking.DAL.Repository().GetById<zAppDev.DotNet.Framework.Identity.Model.ApplicationRole>(Id);
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().Save<zAppDev.DotNet.Framework.Identity.Model.ApplicationRole>(@model.ApplicationRole);
            _result = CloseForm();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().DeleteApplicationRole(@model.ApplicationRole);
            _result = CloseForm();
            return _result;
        }
        #endregion
        ...
        public JsonResult AddPermission_PickList_Datasource()
        {
            ...
            if (datasourceRequest.GroupBy.Any())
            {
                ...
                response.Data = items.ToList().Select(i => new AddPermissionDataSet_ApplicationPermissionDTO(i, true)).ToList();
