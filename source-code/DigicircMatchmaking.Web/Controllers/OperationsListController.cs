...
using DigicircMatchmaking.UI.ViewModels.OperationsList;
...
namespace DigicircMatchmaking.UI.Controllers.OperationsList
{
    ...
    public class OperationsListController : ControllerBase<OperationsListViewModel, OperationsListViewModelDTO>
    {
        ...
        public OperationsListController SetModel(OperationsListViewModel m)
        {
            @model = m;
            return this;
        }
...
// Predefined Ordering
            ...
            if (!__request.OrderBy.Any() && __request.GroupBy.Any())
            {
                var columnInfo0 = new ColumnInfo("ParentControllerName", "string");
        ...
        public JsonResult List_Datasource()
        {
            ...
            if (datasourceRequest.GroupBy.Any())
            {
                ...
                response.Data = items.ToList().Select(i => new List1DataSet_ApplicationOperationDTO(i, true)).ToList();
...
//Fix for total items in GetGroupsClosed
        ...
        public string List_ExportV2Implementation(DatasourceRequest datasourceRequest,
                ExportOptionsV2 exportOptions, List<AggregatorInfo<zAppDev.DotNet.Framework.Identity.Model.ApplicationOperation>> aggregatorsInfo,
