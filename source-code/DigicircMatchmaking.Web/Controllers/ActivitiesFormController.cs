...
using DigicircMatchmaking.UI.ViewModels.ActivitiesForm;
...
namespace DigicircMatchmaking.UI.Controllers.ActivitiesForm
{

    [RoutePrefix("ActivitiesForm")]
    public class ActivitiesFormController : ControllerBase<ActivitiesFormViewModel, ActivitiesFormViewModelDTO>
    {

        /*<Form:ActivitiesForm:0/>*/
        public ActivitiesFormController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(ActivitiesFormController));
        ...
        public ActivitiesFormController SetModel(ActivitiesFormViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(ActivitiesFormViewModel));
        }
        ...
        {
            @model = new ActivitiesFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_ActivitiesForm"] = "Add";
            return null;
        }
        ...
        {
            @model = new ActivitiesFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_ActivitiesForm"] = "Edit";
            return null;
        }
        ...
        public ActionResult ExecuteAdd()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("ActivitiesForm", "RES_PAGETITLE_Add").ToString();
            return _result;
        }
        ...
        public ActionResult ExecuteEdit(int? id)
        {
            ...
            ((MasterPage.MasterPageController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.Activities =  new DigicircMatchmaking.DAL.Repository().GetById<DigicircMatchmaking.BO.Activities>(id);
            @model.Title = BaseViewPage<string>.GetResourceValue("ActivitiesForm", "RES_PAGETITLE_Edit").ToString();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().Save<DigicircMatchmaking.BO.Activities>(@model.Activities);
            _result = CloseForm();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DigicircMatchmaking.DAL.Repository().DeleteActivities(@model.Activities);
            _result = CloseForm();
            return _result;
        }
        #endregion
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new ActivitiesFormViewModelDTO(@model);
        ...
        private ActionResult GetFailedDataValidationsResult(List<string> groupsToCheck = null)
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: ActivitiesForm, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
