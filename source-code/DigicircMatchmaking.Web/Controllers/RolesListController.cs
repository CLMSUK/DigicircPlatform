...
using DigicircMatchmaking.UI.ViewModels.RolesList;
...
namespace DigicircMatchmaking.UI.Controllers.RolesList
{
    ...
    public class RolesListController : ControllerBase<RolesListViewModel, RolesListViewModelDTO>
    {
        ...
        public RolesListController SetModel(RolesListViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        public JsonResult List_Datasource()
        {
            ...
            if (datasourceRequest.GroupBy.Any())
            {
                ...
                response.Data = items.ToList().Select(i => new List1DataSet_ApplicationRoleDTO(i, true)).ToList();
...
//Fix for total items in GetGroupsClosed
        ...
        public string List_ExportV2Implementation(DatasourceRequest datasourceRequest,
                ExportOptionsV2 exportOptions, List<AggregatorInfo<zAppDev.DotNet.Framework.Identity.Model.ApplicationRole>> aggregatorsInfo,
