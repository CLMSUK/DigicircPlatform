...
using DigicircMatchmaking.UI.ViewModels.EntityTypeList;
...
namespace DigicircMatchmaking.UI.Controllers.EntityTypeList
{

    [RoutePrefix("EntityTypeList")]
    public class EntityTypeListController : ControllerBase<EntityTypeListViewModel, EntityTypeListViewModelDTO>
    {

        /*<Form:EntityTypeList:0/>*/
        public EntityTypeListController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(EntityTypeListController));
        ...
        public EntityTypeListController SetModel(EntityTypeListViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(EntityTypeListViewModel));
        }
        ...
        {
            return FileHelper.PendingDownloadInstance.DownloadByKey("EntityTypeList", id);
        }
        ...
        public JsonResult SaveListView()
        {
            ...
            return SaveListView(postedData, "EntityTypeList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return DeleteListView(postedData, "EntityTypeList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return LoadListViews(postedData, "EntityTypeList");
        }
        ...
        {
            @model = new EntityTypeListViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_EntityTypeList"] = "Index";
            return null;
        }
        ...
        public ActionResult ExecuteIndex()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("EntityTypeList", "RES_PAGETITLE_Index").ToString();
            return _result;
        }
        #endregion
        #region Datasource controls
        /*<Datasource:EntityTypeList:1/>*/
        /*<DataSourceFilter:EntityTypeList:2/>*/
        public IQueryable<DigicircMatchmaking.BO.EntityType> Get_EntityTypeList_DatasourceQueryable(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            ...
            var __items = Get_EntityTypeList_DatasourceQueryableImplementation(__request);
            return __items;
        }
        public IQueryable<DigicircMatchmaking.BO.EntityType> Get_EntityTypeList_DatasourceQueryableImplementation(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
        ...
        /*<DataSourceGetFullRecordset:EntityTypeList:1/>*/

        [HttpPost]
        [Route("EntityTypeList_GetFullRecordset")]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "EntityTypeDataSet", ClaimType = ClaimTypes.Dataset)]
        public JsonResult EntityTypeList_GetFullRecordset()
        {
            var postedData = _ParsePostedData();
            ...
            var queryable = Get_EntityTypeList_DatasourceQueryable(datasourceRequest);
            ...
            var data = CreateDtoInstancesFromKeys(typeof(EntityTypeListViewModel), dataType, items.Select(i => i.Id.ToString()).ToList(), "EntityTypeList");
        ...
        /*<DataSourceEntryPoint:EntityTypeList:1/>*/

        [HttpPost]

        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "EntityTypeDataSet", ClaimType = ClaimTypes.Dataset)]
        [Route("EntityTypeList_Datasource")]
        public JsonResult EntityTypeList_Datasource()
        {
            ...
            //Total items count
            if (CLMS.AppDev.Cache.CacheManager.Current.HasKey($"{Request.RequestContext.HttpContext.Session.SessionID}_EntityTypeList_TotalItems"))
            {
                CLMS.AppDev.Cache.CacheManager.Current.Set($"{Request.RequestContext.HttpContext.Session.SessionID}_EntityTypeList_TotalItems", response.TotalRows);
            }
            else
            {
                CLMS.AppDev.Cache.CacheManager.Current.Add($"{Request.RequestContext.HttpContext.Session.SessionID}_EntityTypeList_TotalItems", response.TotalRows);
            }
...
//Fix for total items in GetGroupsClosed
        ...
        /*<DataSourceAggregators:EntityTypeList:1/>*/

        [HttpPost]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "EntityTypeDataSet", ClaimType = ClaimTypes.Dataset)]
        [Route("EntityTypeList_DatasourceAggregators")]
        public JsonResult EntityTypeList_DatasourceAggregators()
        {
            ...
            {
                var aggregatorsInfo = DeserializeAggregatorsRequest<DigicircMatchmaking.BO.EntityType>(postedData["aggregatorsRequest"].ToString());
        ...
        protected class EntityTypeList_CsvRow
        {
            public string Code;
            public string Value;
        }
        ...
        [Route("EntityTypeList_ImportTemplate")]
        [HttpGet]
        public FileResult EntityTypeList_ImportTemplate()
        {
            var csvContents = (BaseViewPage<object>.GetResourceValue("EntityTypeList", "RES_LIST_EntityTypeList_COLUMN_Code") ?? "Code") + ";" +
                              (BaseViewPage<object>.GetResourceValue("EntityTypeList", "RES_LIST_EntityTypeList_COLUMN_Value") ?? "Value");
            var bytes = System.Text.Encoding.ASCII.GetBytes(csvContents);
            var fileName = "EntityTypeList_ImportTemplate.csv";
            return File(bytes, System.Net.Mime.MediaTypeNames.Text.Plain, fileName);
        }


        [Route("EntityTypeList_ImportData")]
        [HttpPost]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "GeneralOperation", ClaimType = ClaimTypes.GenericAction)]
        public JsonResult EntityTypeList_ImportData()
        {
            ...
            {
                _logger.Error("Could not read CSV import file for list 'EntityTypeList'", e);
            ...
            // Extract CSV data
            var _data = new List<EntityTypeList_CsvRow>();
            var _rowCounter = 0;
            while (reader.Read())
            {
                try
                {
                    _rowCounter++;
                    var _row = new EntityTypeList_CsvRow();
                    var _counter = 0;
                ...
                catch(Exception e)
                {
                    ...
                    _logger.Error($"Could not extract data from CSV row #{_rowCounter} for list 'EntityTypeList'", e);
                    result.Errors.Add(new ListImportResult.ImportError
                    {
            ...
            foreach (var _row in _data)
            {
                try
                {
                    ...
                    var _EntityType = new DigicircMatchmaking.BO.EntityType();
                    _EntityType.Code = _row.Code;
                    _EntityType.Value = _row.Value;
                    new DigicircMatchmaking.DAL.Repository().Save(_EntityType);
                    result.NumberImported++;
                }
                catch(Exception e)
                {
                    result.NumberFailled++;
                    _logger.Error($"Could not import data from CSV row #{_rowCounter} for list 'EntityTypeList'", e);
                    result.Errors.Add(new ListImportResult.ImportError
                    {
                        RowNumber = _rowCounter,
        ...
        /*<Datasource:EntityTypeList_EntityTypeDataSet:1/>*/
        /*<DataSourceFilter:EntityTypeList_EntityTypeDataSet:2/>*/
        public IQueryable<DigicircMatchmaking.BO.EntityType> Get_EntityTypeList_EntityTypeDataSet_DatasourceQueryable(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            if (shouldEvict)
            {
            ...
            var __items = Get_EntityTypeList_EntityTypeDataSet_DatasourceQueryableImplementation(__request);
            return __items;
        }
        public IQueryable<DigicircMatchmaking.BO.EntityType> Get_EntityTypeList_EntityTypeDataSet_DatasourceQueryableImplementation(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            var __items = new DigicircMatchmaking.DAL.Repository().GetAsQueryable<DigicircMatchmaking.BO.EntityType>().AsQueryable();
            return __items.Where(@this => true);
        ...
        /*<DataSourceGetFullRecordset:EntityTypeList_EntityTypeDataSet:1/>*/

        [HttpPost]
        [Route("EntityTypeList_EntityTypeDataSet_GetFullRecordset")]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "EntityTypeDataSet", ClaimType = ClaimTypes.Dataset)]
        public JsonResult EntityTypeList_EntityTypeDataSet_GetFullRecordset()
        {
            var postedData = _ParsePostedData();
            var dataType = postedData["dataType"].ToString();
            var keysToExclude = postedData["keys"] == null
            ...
            _LoadViewModel();
            var datasourceRequest = new DatasourceRequest(0, 2147483647, postedDatasourceRequest.Filters, null, keysToExclude, indexes);
            var queryable = Get_EntityTypeList_EntityTypeDataSet_DatasourceQueryable(datasourceRequest);
            var items = DatasourceRetriever.ApplyDynamicFilterToQueryable(datasourceRequest, queryable);
            //The following method of creating DTO responses has been changed due to the fact that the returned objects were missing properties that were not used by the client.
            //It now uses the UpdateInstance method. To be removed after some testing if no problems occur.
            //var data = items.Select(i => new EntityTypeDataSet_EntityTypeDTO(i, true)).ToList();
            var data = CreateDtoInstancesFromKeys(typeof(EntityTypeListViewModel), dataType, items.Select(i => i.Id.ToString()).ToList(), "EntityTypeList_EntityTypeDataSet");
            string __data = Utilities.Serialize(data);
            var __result = Json(new
            {
                Type = "UpdateInstance",Data = __data
        ...
        /*<DataSourceEntryPoint:EntityTypeList_EntityTypeDataSet:1/>*/

        [HttpPost]

        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "EntityTypeDataSet", ClaimType = ClaimTypes.Dataset)]
        [Route("EntityTypeList_EntityTypeDataSet_Datasource")]
        public JsonResult EntityTypeList_EntityTypeDataSet_Datasource()
        {
            var postedData = _LoadViewModel();
            var datasourceRequest = DeserializeDatasourceRequest(postedData["datasourceRequest"].ToString());
            var queryable = Get_EntityTypeList_EntityTypeDataSet_DatasourceQueryable(datasourceRequest);
            ...
            //Total items count
            if (CLMS.AppDev.Cache.CacheManager.Current.HasKey($"{Request.RequestContext.HttpContext.Session.SessionID}_EntityTypeList_EntityTypeDataSet_TotalItems"))
            {
                CLMS.AppDev.Cache.CacheManager.Current.Set($"{Request.RequestContext.HttpContext.Session.SessionID}_EntityTypeList_EntityTypeDataSet_TotalItems", response.TotalRows);
            }
            else
            {
                CLMS.AppDev.Cache.CacheManager.Current.Add($"{Request.RequestContext.HttpContext.Session.SessionID}_EntityTypeList_EntityTypeDataSet_TotalItems", response.TotalRows);
            }
            if (response.TotalRows < datasourceRequest.StartRow + 1)
            {
                datasourceRequest.StartRow = 0;
...
//Fix for total items in GetGroupsClosed
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new EntityTypeListViewModelDTO(@model);
        ...
        private ActionResult GetFailedDataValidationsResult(List<string> groupsToCheck = null)
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: EntityTypeList, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
