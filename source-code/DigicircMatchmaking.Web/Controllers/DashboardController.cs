...
using DigicircMatchmaking.UI.ViewModels.Dashboard;
...
namespace DigicircMatchmaking.UI.Controllers.Dashboard
{
    ...
    public class DashboardController : ControllerBase<DashboardViewModel, DashboardViewModelDTO>
    {
        ...
        public DashboardController SetModel(DashboardViewModel m)
        {
            @model = m;
            return this;
        }
...

        {
            ...
            System.Web.HttpContext.Current.Session["LastEntryPoint_Dashboard"] = "Index";
            return null;
        }
        ...
        public ActionResult ExecuteIndex()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("Dashboard", "RES_PAGETITLE_Index").ToString();
            return _result;
        }
        #endregion
