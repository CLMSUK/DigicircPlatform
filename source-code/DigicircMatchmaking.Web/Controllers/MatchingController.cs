...
using DigicircMatchmaking.UI.ViewModels.Matching;
...
namespace DigicircMatchmaking.UI.Controllers.Matching
{

    [RoutePrefix("Matching")]
    public class MatchingController : ControllerBase<MatchingViewModel, MatchingViewModelDTO>
    {

        /*<Form:Matching:0/>*/
        public MatchingController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(MatchingController));
        ...
        public MatchingController SetModel(MatchingViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(MatchingViewModel));
        }
        ...
        {
            @model = new MatchingViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_Matching"] = "Index";
            return null;
        }
        ...
        [CustomControllerActionFilter(ActionName="Match", ClaimType = ClaimTypes.ControllerAction)]
        [HttpPost]
        [Route("Match")]
        ...
        public ActionResult ExecuteIndex()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("Matching", "RES_PAGETITLE_Index").ToString();
            return _result;
        }
        /*<ControllerActionImplementation:Match:1/>*/
        public ActionResult ExecuteMatch()
        {
            ActionResult _result = null;
            foreach (var actor in new DigicircMatchmaking.DAL.Repository().Get<DigicircMatchmaking.BO.Actor>((a) => a.CircularEconomyRequirements.Resources.Any()) ?? Enumerable.Empty<DigicircMatchmaking.BO.Actor>())
            {
                DigicircMatchmaking.BO.MatchExtensions.MatchProducts(actor);
            }
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new MatchingViewModelDTO(@model);
        ...
        private ActionResult GetFailedDataValidationsResult(List<string> groupsToCheck = null)
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: Matching, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
