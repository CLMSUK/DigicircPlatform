...
namespace DigicircMatchmaking.UI.Controllers.MasterPage
{
    ...
    public class MasterPageController : ControllerBase<MasterPageViewModel, MasterPageViewModelDTO>
    {
        ...
        public MasterPageController SetModel(MasterPageViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        public ActionResult ExecuteRender()
        {
            ...
            @model.AnalyticsId = zAppDev.DotNet.Framework.Utilities.Common.GetConfigurationKey("MatchmakingAnalyticsId");
            return _result;
        }
