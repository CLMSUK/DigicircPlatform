...
using DigicircMatchmaking.UI.ViewModels.ApplicationSettingsList;
...
namespace DigicircMatchmaking.UI.Controllers.ApplicationSettingsList
{
    ...
    public class ApplicationSettingsListController : ControllerBase<ApplicationSettingsListViewModel, ApplicationSettingsListViewModelDTO>
    {
        ...
        public ApplicationSettingsListController SetModel(ApplicationSettingsListViewModel m)
        {
            @model = m;
            return this;
        }
        ...
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            var __items = new DigicircMatchmaking.DAL.Repository().GetAsQueryable<zAppDev.DotNet.Framework.Identity.Model.ApplicationSetting>().AsQueryable();
            return __items;
        }
        ...
        public JsonResult List_Datasource()
        {
            ...
            if (datasourceRequest.GroupBy.Any())
            {
                ...
                response.Data = items.ToList().Select(i => new List1DataSet_ApplicationSettingDTO(i, true)).ToList();
...
//Fix for total items in GetGroupsClosed
        ...
        public string List_ExportV2Implementation(DatasourceRequest datasourceRequest,
                ExportOptionsV2 exportOptions, List<AggregatorInfo<zAppDev.DotNet.Framework.Identity.Model.ApplicationSetting>> aggregatorsInfo,
