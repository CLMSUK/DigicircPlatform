...
namespace DigicircMatchmaking.Locales
{
    ...
    public class LocaleResolver
    {
        ...
        private static string ReadEmbededResource(string fullPath)
        {
            ...
            var stream = typeof(DigicircMatchmaking.Locales.LocaleResolver).Assembly.GetManifestResourceStream(fullPath);
            if (stream == null)
            {
                stream = typeof(DigicircMatchmaking.Locales.LocaleResolver).Assembly.GetManifestResourceStream("Locales." + fullPath);
            }
            if(stream == null)
            {
                stream = typeof(DigicircMatchmaking.Locales.LocaleResolver).Assembly.GetManifestResourceStream("DigicircMatchmaking."+ "Locales." + fullPath);
            }
            if(stream == null)
            {
                stream = typeof(DigicircMatchmaking.Locales.LocaleResolver).Assembly.GetManifestResourceStream("DigicircMatchmaking."+ "Locales.Locales." + fullPath);
            }
            if(stream == null)
            {
                stream = typeof(DigicircMatchmaking.Locales.LocaleResolver).Assembly.GetManifestResourceStream("DigicircMatchmaking.Backend."+ "Locales.Locales." + fullPath);
            }
