...
namespace DigicircMatchmaking.BO
{
    ...
    public class SuggestionsFlowWorkflow : WorkflowImplementation
    {
        ...
        #region Step Fields
        private readonly SuggestionsFlowStep0 Step0 = new SuggestionsFlowStep0();
        #endregion
        ...
        public DigicircMatchmaking.BO.SuggestionsFlowContext Context;
        #endregion
        public SuggestionsFlowWorkflow()
        {
            Context = new DigicircMatchmaking.BO.SuggestionsFlowContext();
        ...
        public WorkflowStatus? Run()
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(GetType()).Error($"Error running workflow 'SuggestionsFlow'!", e);
        ...
        public override T GetStep<T>()
        {
            ...
            if (stepName == SuggestionsFlowStep0.StepName)
            {
                Step0Step(false);
                return Step0 as T;
            }
        ...
        public override WorkflowStatus? Continue(string stepName)
        {
            ...
            {
                Context.Error = $"Message: {e.Message}\n StackTrace: {e.StackTrace}";
                log4net.LogManager.GetLogger(GetType()).Error($"Error continuing workflow 'SuggestionsFlow'", e);
                throw;
            }
        }
        ...
        {
            Context = state as DigicircMatchmaking.BO.SuggestionsFlowContext;
        }
    }
    #endregion
    #region Steps
    public class SuggestionsFlowStep0 : IWorkflowStep
    {
        ...
        {
            if (!ClaimPermission.CheckAccess(ClaimTypes.IDEF0Activity, "SuggestionsFlow", "Step0"))
            {
                IdentityHelper.LogAction("SuggestionsFlow", "Step0", false, "Unauthorized");
                throw new UnauthorizedAccessException("You do not have permissions to execute step 'Step0' of 'SuggestionsFlow' Workflow");
            }
            return true;
        }
        public WorkflowStatus? Run()
