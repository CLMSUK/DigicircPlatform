...
(function (DigicircMatchmaking) {
    ...
    (function (ViewModels) {
        ...
        (function (ForgotUsername) {
            var ForgotUsernameViewModel = /** @class */ (function (_super) {
                __extends(ForgotUsernameViewModel, _super);
                function ForgotUsernameViewModel() {
                    return _super.call(this) || this;
                }
                ForgotUsernameViewModel._lightCast = function (instance) {
                    if (instance == null)
                        return;
                    return instance;
                };
                ForgotUsernameViewModel._initializeFrom = function (original, ignoreReadOnlyProperties, context) {
                    ...
                    // }
                    var result = new ForgotUsernameViewModel();
                ...
                ForgotUsernameViewModel.prototype._hydrateForgotUsernameViewModel = function (original, ignoreReadOnlyProperties, context) {
                    if (context === void 0) { context = new Joove.DTOHelper(); }
                    if (original == null)
                        return;
                ...
                ForgotUsernameViewModel.prototype._reduceData = function (ignoreReadOnlyProperties) {
                    var reduced = ForgotUsernameViewModel._initializeFrom(this, ignoreReadOnlyProperties);
                    ForgotUsernameViewModel._deleteDropDownInitialValues(reduced);
                    return reduced;
                };
                ForgotUsernameViewModel._deleteDropDownInitialValues = function (reduced) {
                    if (reduced == null)
                        return;
            ...
            ForgotUsername.ForgotUsernameViewModel = ForgotUsernameViewModel;
        })(ForgotUsername = ViewModels.ForgotUsername || (ViewModels.ForgotUsername = {}));
