...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var _this = this;
        var ActorFormConditionalFormattings = [
            new Joove.JbRule({
            ...
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return window["scope_ActorForm"].model.Actor.EntityType.IsProvider; }, false)];
                    });
                }); },
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
                                return Joove.Common.nullSafe(function () { return window["scope_ActorForm"].model.Title; }, "").trim();
                            }, "")); }, false)];
                    });
                }); },
                evaluationTimes: [Joove.EvaluationTimes.OnLoad, Joove.EvaluationTimes.OnSubmit, Joove.EvaluationTimes.OnChange],
            ...
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return window._context.currentAction == "Show"; }, false) && Joove.Common.nullSafe(function () { return window["scope_ActorForm"].model.SignInUser; }, null) == Joove.Common.nullSafe(function () { return window["scope_ActorForm"].model.Actor.AddedBy; }, null)];
                    });
                }); },
                evaluationTimes: [Joove.EvaluationTimes.OnLoad, Joove.EvaluationTimes.OnSubmit, Joove.EvaluationTimes.OnChange],
                isRelatedToDataValidation: false
            ...
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return window["scope_ActorForm"].model.Actor.EntityType.Code; }, "") == "Other"];
                    });
                }); },
                evaluationTimes: [Joove.EvaluationTimes.OnLoad, Joove.EvaluationTimes.OnSubmit, Joove.EvaluationTimes.OnChange],
                isRelatedToDataValidation: false
            ...
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return window["scope_ActorForm"].model.Actor.CircularEconomyRequirements.ExperienceInCircularEconomy; }, false)];
                    });
                }); },
                evaluationTimes: [Joove.EvaluationTimes.OnLoad, Joove.EvaluationTimes.OnChange],
                isRelatedToDataValidation: false
            ...
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return window["scope_ActorForm"].model.Actor.EntityType.IsCluster; }, false)];
                    });
                }); },
                evaluationTimes: [Joove.EvaluationTimes.OnLoad, Joove.EvaluationTimes.OnChange],
                isRelatedToDataValidation: false
            ...
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return window["scope_ActorForm"].model.Actor.MemberOfCluster; }, false)];
                    });
                }); },
                evaluationTimes: [Joove.EvaluationTimes.OnLoad, Joove.EvaluationTimes.OnSubmit, Joove.EvaluationTimes.OnChange],
                isRelatedToDataValidation: false
            ...
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return window["scope_ActorForm"].model.Actor.HasSites; }, false)];
                    });
                }); },
                evaluationTimes: [Joove.EvaluationTimes.OnLoad, Joove.EvaluationTimes.OnChange],
                isRelatedToDataValidation: false
        ...
        var ActorFormDataValidations = [];
        var ActorFormCalculatedExpressions = [];
        ...
        Controllers.ClustersDataset_ColumnInfo = [new Joove.ColumnInfo("Name", "string", null, false),
            new Joove.ColumnInfo("original", "Actor", null, false)];
        window["ClustersDataset_ColumnInfo"] = Controllers.ClustersDataset_ColumnInfo;
        ...
        Controllers.DigitalExpertiseDataset_ColumnInfo = [new Joove.ColumnInfo("Value", "string", null, true)];
        window["DigitalExpertiseDataset_ColumnInfo"] = Controllers.DigitalExpertiseDataset_ColumnInfo;
        ...
        var ActorFormMapPointsViewModelDataset = /** @class */ (function (_super) {
            __extends(ActorFormMapPointsViewModelDataset, _super);
            function ActorFormMapPointsViewModelDataset(model, partialViewControlName) {
                if (partialViewControlName === void 0) { partialViewControlName = null; }
                var _this = _super.call(this, model, partialViewControlName) || this;
                _this.limit = 0;
                return _this;
            }
            ActorFormMapPointsViewModelDataset.prototype.Filter = function (inputs) {
                var $scope = { model: this.model };
                return function (DataItem, index, items) {
                    return true;
                };
            };
            ActorFormMapPointsViewModelDataset.prototype.PackInputs = function ($control) {
                return Joove.DatasourceManager.getDatasetControlInputs($control);
            };
            ActorFormMapPointsViewModelDataset.prototype.Sort = function (items) {
                return items;
            };
            ActorFormMapPointsViewModelDataset.prototype.GetSource = function (parents) {
                return this.model.Points;
            };
            return ActorFormMapPointsViewModelDataset;
        }(Joove.IViewModelDataset));
        Controllers.ActorFormMapPointsViewModelDataset = ActorFormMapPointsViewModelDataset;
        ...
        window["ImageBox_ProjectionScema"] = { Actor: { Id: '',
                _key: '',
                ActorLogo: { Id: '',
                    _key: '',
                    Description: {},
        ...
        var ActorFormController = /** @class */ (function () {
            function ActorFormController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.ActorForm.ActorFormViewModel._initializeFrom($scope.model, context);
                };
            ...
            ActorFormController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                ...
                $scope.actions = {
                    ...
                    Show: function (id, _cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            Joove.Common.autocompleteFix();
                    ...
                    SetNewGeolocation: function (_cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                case 0:
                                    ...
                                    implementation = function () { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            ...
                                            Joove.Common.nullSafe(function () { return window._commander.hideModal("ChooseMapPositionPoint"); }, null);
                                            return [2 /*return*/];
                                        });
                                    }); };
                    ...
                    UpdateGeolocation: function (_cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        var implementation, spamHelper;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    implementation = function () { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            Joove.Common.nullSafe(function () { return window["scope_ActorForm"].model.Points.clear(); }, null);
                                            Joove.Common.nullSafe(function () { return window["scope_ActorForm"].model.Points.add(Joove.Common.nullSafe(function () { return window["scope_ActorForm"].model.Actor; }, null)); }, null);
                                            Joove.Common.nullSafe(function () { return window._commander.mapRefresh(["NewMap1"]); }, null);
                                            return [2 /*return*/];
                                        });
                                    }); };
                                    spamHelper = new Joove.SpamControlHelper(_e);
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    implementation = function () { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            Joove.Common.nullSafe(function () { return window["scope_ActorForm"].model.Actor.SectorTypes.clear(); }, null);
                                            Joove.Common.nullSafe(function () { return window["scope_ActorForm"].model.Actor.SectorTypes.add(Joove.Common.nullSafe(function () { return window["scope_ActorForm"].model.SelectedSector; }, null)); }, null);
                                            return [2 /*return*/];
                                        });
                                    }); };
                                    spamHelper = new Joove.SpamControlHelper(_e);
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    implementation = function () { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            Joove.Common.nullSafe(function () { return Joove.Core.executeRedirectControllerAction("SearchForm", "FromBack", "GET", [Joove.Common.nullSafe(function () { return window["scope_ActorForm"].model.Actor.Id; }, 0)], {}, _modalOptions); }, null);
                                            return [2 /*return*/];
                                        });
                                    }); };
                                    spamHelper = new Joove.SpamControlHelper(_e);
                    ...
                    SaveNewCluster: function (_cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            Joove.Common.autocompleteFix();
                            Joove.Core.executeControllerActionNew({
                    ...
                    AddNewCluster: function (_cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        var implementation, spamHelper;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                ...
                $scope.eventCallbacks = {
                    ...
                    EditButtonClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockEditButtonClicked = $timeout(function () {
                            ...
                            Joove.Common.setLastClickedElement(e);
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                $scope.actions.Edit(Joove.Common.nullSafe(function () { return window["scope_ActorForm"].model.Actor.Id; }, 0), null, null, e);
                            }, { groups: [Joove.Validation.Constants.ALL_GROUPS], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
                    ...
                    TextBoxOnChange: function (e, DataItem, _parents) {
                        if (_this.timeoutDelayLockTextBoxOnChange != null) {
                            $timeout.cancel(_this.timeoutDelayLockTextBoxOnChange);
                        }
                        _this.timeoutDelayLockTextBoxOnChange = $timeout(function () {
                            if (e.target) {
                    ...
                    TextBox4OnChange: function (e, DataItem, _parents) {
                        if (_this.timeoutDelayLockTextBox4OnChange != null) {
                            $timeout.cancel(_this.timeoutDelayLockTextBox4OnChange);
                        }
                        _this.timeoutDelayLockTextBox4OnChange = $timeout(function () {
                            if (e.target) {
                                Joove.Core.onChange(e.target, null, false);
                            }
                            else {
                    ...
                    TextBox5OnChange: function (e, DataItem, _parents) {
                        if (_this.timeoutDelayLockTextBox5OnChange != null) {
                            $timeout.cancel(_this.timeoutDelayLockTextBox5OnChange);
                        }
                        _this.timeoutDelayLockTextBox5OnChange = $timeout(function () {
                            if (e.target) {
                                Joove.Core.onChange(e.target, null, false);
                            }
                            else {
            ...
            return ActorFormController;
        }());
        angular.module("Application").controller("ActorFormController", ["$scope", "$timeout", ActorFormController]);
