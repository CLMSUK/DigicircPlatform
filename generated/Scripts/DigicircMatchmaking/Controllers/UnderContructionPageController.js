...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var UnderContructionPageConditionalFormattings = [];
        var UnderContructionPageDataValidations = [];
        var UnderContructionPageCalculatedExpressions = [];
        var UnderContructionPageController = /** @class */ (function () {
            function UnderContructionPageController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.UnderContructionPage.UnderContructionPageViewModel._initializeFrom($scope.model, context);
                };
            ...
            UnderContructionPageController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return UnderContructionPageController;
        }());
        angular.module("Application").controller("UnderContructionPageController", ["$scope", "$timeout", UnderContructionPageController]);
