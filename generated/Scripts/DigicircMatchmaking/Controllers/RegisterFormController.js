...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var _this = this;
        var RegisterFormConditionalFormattings = [
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return window["scope_RegisterForm"].model.AcceptTerms; }, false)];
                    });
                }); },
        ...
        var RegisterFormDataValidations = [
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return window["scope_RegisterForm"].model.UserName.trim(); }, "") == ""];
                    });
                }); },
            ...
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () { return window["scope_RegisterForm"].model.Password; }, "")); }, false) && Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () { return window["scope_RegisterForm"].model.RetypePassword; }, "")); }, false) && Joove.Common.nullSafe(function () { return window["scope_RegisterForm"].model.Password.trim(); }, "") != Joove.Common.nullSafe(function () { return window["scope_RegisterForm"].model.RetypePassword.trim(); }, "")];
                    });
                }); },
                expression: function (_parents) {
                    return __awaiter(this, void 0, void 0, function () {
        ...
        var RegisterFormCalculatedExpressions = [];
        var RegisterFormController = /** @class */ (function () {
            function RegisterFormController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.RegisterForm.RegisterFormViewModel._initializeFrom($scope.model, context);
                };
                $scope._validationsMaster = window.scope_MasterPageSignIn._validations;
                $scope._validations = { summary: [],
                    EmptyUsername: { rule: RegisterFormDataValidations[0], group: RegisterFormDataValidations[0].group },
                    PasswordsMatch: { rule: RegisterFormDataValidations[1], group: RegisterFormDataValidations[1].group },
                    txtUserName: { requiredControlId: 'txtUserName', group: null },
                    txtPassword: { requiredControlId: 'txtPassword', group: null },
                    txtRetypePassword: { requiredControlId: 'txtRetypePassword', group: null },
                };
            ...
            RegisterFormController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                ...
                // Controller actions
                $scope.actions = {
                    Index: function (fromMatching, _cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                    ...
                    Register: function (_cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    Joove.Common.autocompleteFix();
                    ...
                    Button1Clicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockButton1Clicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("SignInPage", "Load", "GET", [Joove.Common.nullSafe(function () { return window["scope_RegisterForm"].model.FromMatching; }, false)], null, null, openInNewWindow);
        ...
        angular.module("Application").controller("RegisterFormController", ["$scope", "$timeout", RegisterFormController]);
