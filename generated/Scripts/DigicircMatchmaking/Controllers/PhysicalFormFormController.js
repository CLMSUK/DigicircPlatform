...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var _this = this;
        var PhysicalFormFormConditionalFormattings = [
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
                                return Joove.Common.nullSafe(function () { return window["scope_PhysicalFormForm"].model.Title; }, "").trim();
                            }, "")); }, false)];
                    });
                }); },
        ...
        var PhysicalFormFormDataValidations = [];
        var PhysicalFormFormCalculatedExpressions = [];
        var PhysicalFormFormController = /** @class */ (function () {
            function PhysicalFormFormController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.PhysicalFormForm.PhysicalFormFormViewModel._initializeFrom($scope.model, context);
                };
            ...
            PhysicalFormFormController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return PhysicalFormFormController;
        }());
        angular.module("Application").controller("PhysicalFormFormController", ["$scope", "$timeout", PhysicalFormFormController]);
