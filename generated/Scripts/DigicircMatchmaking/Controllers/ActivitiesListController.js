...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var ActivitiesListConditionalFormattings = [];
        var ActivitiesListDataValidations = [];
        var ActivitiesListCalculatedExpressions = [];
        ...
        var ActivitiesListController = /** @class */ (function () {
            function ActivitiesListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.ActivitiesList.ActivitiesListViewModel._initializeFrom($scope.model, context);
                };
            ...
            ActivitiesListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                    ...
                    AddNewClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockAddNewClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("ActivitiesForm", "Add", "GET", [], null, null, openInNewWindow);
                    ...
                    ModifyClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockModifyClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("ActivitiesForm", "Edit", "GET", [Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItem($("[jb-id='ActivitiesList']"), e).Id; }, 0)], null, null, openInNewWindow);
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
                };
        ...
        angular.module("Application").controller("ActivitiesListController", ["$scope", "$timeout", ActivitiesListController]);
