...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var _this = this;
        var ProcessFormConditionalFormattings = [
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
                                return Joove.Common.nullSafe(function () { return window["scope_ProcessForm"].model.Title; }, "").trim();
                            }, "")); }, false)];
                    });
                }); },
        ...
        var ProcessFormDataValidations = [];
        var ProcessFormCalculatedExpressions = [];
        var ProcessFormController = /** @class */ (function () {
            function ProcessFormController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.ProcessForm.ProcessFormViewModel._initializeFrom($scope.model, context);
                };
            ...
            ProcessFormController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return ProcessFormController;
        }());
        angular.module("Application").controller("ProcessFormController", ["$scope", "$timeout", ProcessFormController]);
