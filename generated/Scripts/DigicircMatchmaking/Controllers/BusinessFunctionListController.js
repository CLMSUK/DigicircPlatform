...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var BusinessFunctionListConditionalFormattings = [];
        var BusinessFunctionListDataValidations = [];
        var BusinessFunctionListCalculatedExpressions = [];
        ...
        var BusinessFunctionListController = /** @class */ (function () {
            function BusinessFunctionListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.BusinessFunctionList.BusinessFunctionListViewModel._initializeFrom($scope.model, context);
                };
            ...
            BusinessFunctionListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                    ...
                    AddNewClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockAddNewClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("BusinessFunctionForm", "Add", "GET", [], null, null, openInNewWindow);
                    ...
                    ModifyClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockModifyClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("BusinessFunctionForm", "Edit", "GET", [Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItem($("[jb-id='BusinessFunctionList']"), e).Id; }, 0)], null, null, openInNewWindow);
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
                };
            ...
            return BusinessFunctionListController;
        }());
        angular.module("Application").controller("BusinessFunctionListController", ["$scope", "$timeout", BusinessFunctionListController]);
