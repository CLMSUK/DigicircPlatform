...
(function (DigicircMatchmaking) {
    ...
    (function (Controllers) {
        var _this = this;
        var BusinessFunctionFormConditionalFormattings = [
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
                                return Joove.Common.nullSafe(function () { return window["scope_BusinessFunctionForm"].model.Title; }, "").trim();
                            }, "")); }, false)];
                    });
                }); },
        ...
        var BusinessFunctionFormDataValidations = [];
        var BusinessFunctionFormCalculatedExpressions = [];
        var BusinessFunctionFormController = /** @class */ (function () {
            function BusinessFunctionFormController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DigicircMatchmaking.ViewModels.BusinessFunctionForm.BusinessFunctionFormViewModel._initializeFrom($scope.model, context);
                };
            ...
            BusinessFunctionFormController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return BusinessFunctionFormController;
        }());
        angular.module("Application").controller("BusinessFunctionFormController", ["$scope", "$timeout", BusinessFunctionFormController]);
